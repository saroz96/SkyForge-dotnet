...
//         let month = '', year = '', nepaliMonth = '', nepaliYear = '', fromDateAd = '', toDateAd = '';
...
//                         const lastDayNum = getLastDayOfNepaliMonth(yearInt, monthInt);
//                         const lastDayNepali = new NepaliDate(yearInt, monthInt - 1, lastDayNum);
//                         fromDateAd = convertBsToAd(firstDayNepali.format('YYYY-MM-DD')) || currentEnglishDate;
//                         toDateAd = convertBsToAd(lastDayNepali.format('YYYY-MM-DD')) || currentEnglishDate;
//                     } else {
//                         fromDateAd = currentEnglishDate;
//                         toDateAd = currentEnglishDate;
//                     }
...
//                 const currentYear = currentNepaliDateObj.getYear();
//                 const currentMonth = currentNepaliDateObj.getMonth() + 1;
//                 nepaliYear = currentMonth >= 4 ? `${currentYear}/${currentYear + 1}` : `${currentYear - 1}/${currentYear}`;
//                 try {
//                     const fiscalStartYear = parseInt(nepaliYear.split('/')[0]);
//                     const fiscalEndYear = fiscalStartYear + 1;
//                     if (fiscalStartYear > 2000 && fiscalEndYear > 2000) {
...
//                 toDateAd: defaultValues.toDateAd
//             }));
//             setData(prev => ({ ...prev, totals: null, monthlyData: [] }));
//         } catch (error) {
//             console.error('Error in auto-fill:', error);
//         }
//     }, [dateSelection.periodType, company.dateFormat, getDefaultValues]);
...
//         };
//         fetchReportData();
//     }, [shouldFetch, dateSelection, company.dateFormat]);
...
//             if (company.dateFormat === 'nepali') {
//                 if (!dateSelection.nepaliMonth || !dateSelection.nepaliYear) {
//                     setNotification({ show: true, message: 'Please select both Nepali month and year', type: 'warning' });
//                     return;
//                 }
//                 const monthInt = parseInt(dateSelection.nepaliMonth);
//                 if (monthInt < 1 || monthInt > 12) {
//                     setNotification({ show: true, message: 'Invalid Nepali month selected', type: 'warning' });
//                     return;
//                 }
//             } else {
//                 if (!dateSelection.month || !dateSelection.year) {
//                     setNotification({ show: true, message: 'Please select both month and year', type: 'warning' });
//                     return;
//                 }
//                 const monthInt = parseInt(dateSelection.month);
//                 if (monthInt < 1 || monthInt > 12) {
//                     setNotification({ show: true, message: 'Invalid month selected', type: 'warning' });
//                     return;
//                 }
//             }
//         } else {
//             if (company.dateFormat === 'nepali') {
//                 if (!dateSelection.nepaliYear) {
//                     setNotification({ show: true, message: 'Please select Nepali fiscal year (format: YYYY/YYYY)', type: 'warning' });
//                     return;
//                 }
//                 if (!/^\d{4}\/\d{4}$/.test(dateSelection.nepaliYear)) {
//                     setNotification({ show: true, message: 'Please enter fiscal year in format: YYYY/YYYY', type: 'warning' });
//                     return;
//                 }
//                 if (!dateSelection.fromDateAd || !dateSelection.toDateAd) {
...
//             } else {
//                 if (!dateSelection.year) {
//                     setNotification({ show: true, message: 'Please select year', type: 'warning' });
//                     return;
//                 }
//             }
//         }
...
//     const getCurrentNepaliFiscalYear = useCallback(() => {
//         const currentNepaliDate = new NepaliDate();
//         const currentYear = currentNepaliDate.getYear();
//         const currentMonth = currentNepaliDate.getMonth() + 1;
...
//     const formatCurrencyForExport = useCallback((num) => {
//         const number = typeof num === 'string' ? parseFloat(num.replace(/,/g, '')) : Number(num) || 0;
//         return number.toFixed(2);
//     }, []);
...
//             setNotification({ show: true, message: 'Failed to export: ' + err.message, type: 'error' });
//         } finally {
//             setExporting(false);
//         }
//     }, [data, dateSelection.periodType, formatCurrencyForExport]);
...
//         printWindow.document.write(printContent);
//         printWindow.document.close();
//     }, [data, dateSelection.periodType, formatCurrency, getNetValueClass]);

//     if (loading && !data.totals && data.monthlyData.length === 0) return <Loader />;

//     const currentNepaliYear = new NepaliDate().getYear();

//     return (
//         <div className="monthly-vat-page">
//             <Header />

//             <div className="mv-shell">
//                 {/* Compact top bar */}
//                 <div className="mv-topbar">
//                     <div className="mv-topbar__left">
//                         <div className="mv-topbar__icon"><FiFileText /></div>
//                         <div>
...
//                     <div className="mv-field mv-field--period">
...
//                         company.dateFormat === 'english' ? (
//                             <>
//                                 <div className="mv-field mv-field--month">
...
//                                     </select>
//                                 </div>
//                                 <div className="mv-field mv-field--year">
...
//                             <>
//                                 <div className="mv-field mv-field--month">
//                                     <label>Month (Nepali) <span className="req">*</span></label>
//                                     <select
//                                         name="nepaliMonth"
//                                         id="nepaliMonth"
//                                         ref={nepaliMonthRef}
...
//                                 </div>
//                                 <div className="mv-field mv-field--year">
//                                     <label>Year (Nepali) <span className="req">*</span></label>
//                                     <input
//                                         type="text"
//                                         name="nepaliYear"
//                                         id="nepaliYear"
...
//                                         onChange={handleDateChange}
//                                         onKeyDown={(e) => handleKeyDown(e, 'generateReport')}
//                                         placeholder={`e.g. ${currentNepaliYear}`}
//                                         autoComplete="off"
//                                     />
//                                 </div>
//                             </>
...
//                             </div>
//                         ) : (
//                             <div className="mv-field mv-field--year mv-field--fiscal">
//                                 <label>Fiscal Year (Nepali) <span className="req">*</span></label>
//                                 <input
//                                     type="text"
//                                     name="nepaliYear"
//                                     id="nepaliYear"
...
//                     {/* Period display */}
//                     {data.reportDateRange && (
//                         <div className="mv-period">
//                             <FiCalendar className="me-1" style={{ fontSize: '0.65rem' }} />
//                             <span>{data.reportDateRange}</span>
//                         </div>
//                     )}
//                 </div>
...
//                             <h3>No data</h3>
//                             <p>Select period and date, then click Generate.</p>
//                         </div>
//                     ) : (
//                         <>
//                             <div className="mv-main__bar">
//                                 <span><strong>{data.currentCompanyName || 'Company'}</strong></span>
//                                 <span>{data.reportDateRange}</span>
//                             </div>
...
//                                     <thead>
//                                         <tr>
//                                             <th rowSpan="2" className="text-center align-middle" style={{ minWidth: '120px' }}>Date Range</th>
//                                             <th colSpan="4" className="text-center bg-primary text-white">Purchase</th>
//                                             <th className="bg-light" style={{ width: '8px' }}></th>
...
//                                         </tr>
//                                         <tr>
//                                             <th>Taxable</th><th>Non-VAT</th><th>VAT</th><th>Total</th>
//                                             <th className="bg-light"></th>
//                                             <th>Taxable</th><th>Non-VAT</th><th>VAT</th><th>Total</th>
//                                             <th className="bg-light"></th>
//                                             <th>Taxable</th><th>Non-VAT</th><th>Total</th>
//                                             <th className="bg-light"></th>
//                                             <th>Taxable</th><th>Non-VAT</th><th>VAT</th><th>Total</th>
//                                             <th className="bg-light"></th>
//                                             <th>Taxable</th><th>Non-VAT</th><th>VAT</th><th>Total</th>
...
//                                                     <tr key={idx}>
//                                                         <td className="align-middle"><strong>{monthData.reportDateRange}</strong></td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.purchase?.taxableAmount)}</td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.purchase?.nonVatAmount)}</td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.purchase?.vatAmount)}</td>
//                                                         <td className="num fw-bold">{formatCurrency((monthData.totals?.purchase?.taxableAmount || 0) + (monthData.totals?.purchase?.nonVatAmount || 0) + (monthData.totals?.purchase?.vatAmount || 0))}</td>
//                                                         <td className="bg-light"></td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.purchaseReturn?.taxableAmount)}</td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.purchaseReturn?.nonVatAmount)}</td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.purchaseReturn?.vatAmount)}</td>
//                                                         <td className="num fw-bold">{formatCurrency((monthData.totals?.purchaseReturn?.taxableAmount || 0) + (monthData.totals?.purchaseReturn?.nonVatAmount || 0) + (monthData.totals?.purchaseReturn?.vatAmount || 0))}</td>
//                                                         <td className="bg-light"></td>
//                                                         <td className={`num ${getNetValueClass(netPurchaseTaxable)}`}>{formatCurrency(netPurchaseTaxable)}</td>
//                                                         <td className={`num ${getNetValueClass(netPurchaseNonVat)}`}>{formatCurrency(netPurchaseNonVat)}</td>
//                                                         <td className={`num ${getNetValueClass(netPurchaseTotal)}`}>{formatCurrency(netPurchaseTotal)}</td>
//                                                         <td className="bg-light"></td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.sales?.taxableAmount)}</td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.sales?.nonVatAmount)}</td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.sales?.vatAmount)}</td>
//                                                         <td className="num fw-bold">{formatCurrency((monthData.totals?.sales?.taxableAmount || 0) + (monthData.totals?.sales?.nonVatAmount || 0) + (monthData.totals?.sales?.vatAmount || 0))}</td>
//                                                         <td className="bg-light"></td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.salesReturn?.taxableAmount)}</td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.salesReturn?.nonVatAmount)}</td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.salesReturn?.vatAmount)}</td>
//                                                         <td className="num fw-bold">{formatCurrency((monthData.totals?.salesReturn?.taxableAmount || 0) + (monthData.totals?.salesReturn?.nonVatAmount || 0) + (monthData.totals?.salesReturn?.vatAmount || 0))}</td>
//                                                         <td className="bg-light"></td>
//                                                         <td className={`num ${getNetValueClass(netSalesTaxable)}`}>{formatCurrency(netSalesTaxable)}</td>
//                                                         <td className={`num ${getNetValueClass(netSalesNonVat)}`}>{formatCurrency(netSalesNonVat)}</td>
//                                                         <td className={`num ${getNetValueClass(netSalesTotal)}`}>{formatCurrency(netSalesTotal)}</td>
//                                                         <td className="bg-light"></td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.netPurchaseVat)}</td>
//                                                         <td className="num">{formatCurrency(monthData.totals?.netSalesVat)}</td>
//                                                         <td className={`num ${getNetValueClass(monthData.totals?.netVat)}`}>{formatCurrency(monthData.totals?.netVat)}</td>
//                                                     </tr>
//                                                 );
//                                             })
//                                         ) : data.totals ? (
//                                             <tr>
//                                                 <td className="align-middle"><strong>{data.reportDateRange}</strong></td>
//                                                 <td className="num">{formatCurrency(data.totals.purchase?.taxableAmount)}</td>
//                                                 <td className="num">{formatCurrency(data.totals.purchase?.nonVatAmount)}</td>
//                                                 <td className="num">{formatCurrency(data.totals.purchase?.vatAmount)}</td>
//                                                 <td className="num fw-bold">{formatCurrency((data.totals.purchase?.taxableAmount || 0) + (data.totals.purchase?.nonVatAmount || 0) + (data.totals.purchase?.vatAmount || 0))}</td>
//                                                 <td className="bg-light"></td>
//                                                 <td className="num">{formatCurrency(data.totals.purchaseReturn?.taxableAmount)}</td>
//                                                 <td className="num">{formatCurrency(data.totals.purchaseReturn?.nonVatAmount)}</td>
//                                                 <td className="num">{formatCurrency(data.totals.purchaseReturn?.vatAmount)}</td>
//                                                 <td className="num fw-bold">{formatCurrency((data.totals.purchaseReturn?.taxableAmount || 0) + (data.totals.purchaseReturn?.nonVatAmount || 0) + (data.totals.purchaseReturn?.vatAmount || 0))}</td>
//                                                 <td className="bg-light"></td>
//                                                 <td className={`num ${getNetValueClass((data.totals.purchase?.taxableAmount || 0) - (data.totals.purchaseReturn?.taxableAmount || 0))}`}>
//                                                     {formatCurrency((data.totals.purchase?.taxableAmount || 0) - (data.totals.purchaseReturn?.taxableAmount || 0))}
//                                                 </td>
//                                                 <td className={`num ${getNetValueClass((data.totals.purchase?.nonVatAmount || 0) - (data.totals.purchaseReturn?.nonVatAmount || 0))}`}>
//                                                     {formatCurrency((data.totals.purchase?.nonVatAmount || 0) - (data.totals.purchaseReturn?.nonVatAmount || 0))}
//                                                 </td>
//                                                 <td className={`num ${getNetValueClass(((data.totals.purchase?.taxableAmount || 0) + (data.totals.purchase?.nonVatAmount || 0) + (data.totals.purchase?.vatAmount || 0)) -
//                                                     ((data.totals.purchaseReturn?.taxableAmount || 0) + (data.totals.purchaseReturn?.nonVatAmount || 0) + (data.totals.purchaseReturn?.vatAmount || 0)))}`}>
//                                                     {formatCurrency(((data.totals.purchase?.taxableAmount || 0) + (data.totals.purchase?.nonVatAmount || 0) + (data.totals.purchase?.vatAmount || 0)) -
//                                                         ((data.totals.purchaseReturn?.taxableAmount || 0) + (data.totals.purchaseReturn?.nonVatAmount || 0) + (data.totals.purchaseReturn?.vatAmount || 0)))}
//                                                 </td>
//                                                 <td className="bg-light"></td>
//                                                 <td className="num">{formatCurrency(data.totals.sales?.taxableAmount)}</td>
//                                                 <td className="num">{formatCurrency(data.totals.sales?.nonVatAmount)}</td>
//                                                 <td className="num">{formatCurrency(data.totals.sales?.vatAmount)}</td>
//                                                 <td className="num fw-bold">{formatCurrency((data.totals.sales?.taxableAmount || 0) + (data.totals.sales?.nonVatAmount || 0) + (data.totals.sales?.vatAmount || 0))}</td>
//                                                 <td className="bg-light"></td>
//                                                 <td className="num">{formatCurrency(data.totals.salesReturn?.taxableAmount)}</td>
//                                                 <td className="num">{formatCurrency(data.totals.salesReturn?.nonVatAmount)}</td>
//                                                 <td className="num">{formatCurrency(data.totals.salesReturn?.vatAmount)}</td>
//                                                 <td className="num fw-bold">{formatCurrency((data.totals.salesReturn?.taxableAmount || 0) + (data.totals.salesReturn?.nonVatAmount || 0) + (data.totals.salesReturn?.vatAmount || 0))}</td>
//                                                 <td className="bg-light"></td>
//                                                 <td className={`num ${getNetValueClass((data.totals.sales?.taxableAmount || 0) - (data.totals.salesReturn?.taxableAmount || 0))}`}>
//                                                     {formatCurrency((data.totals.sales?.taxableAmount || 0) - (data.totals.salesReturn?.taxableAmount || 0))}
//                                                 </td>
//                                                 <td className={`num ${getNetValueClass((data.totals.sales?.nonVatAmount || 0) - (data.totals.salesReturn?.nonVatAmount || 0))}`}>
//                                                     {formatCurrency((data.totals.sales?.nonVatAmount || 0) - (data.totals.salesReturn?.nonVatAmount || 0))}
//                                                 </td>
//                                                 <td className={`num ${getNetValueClass(((data.totals.sales?.taxableAmount || 0) + (data.totals.sales?.nonVatAmount || 0) + (data.totals.sales?.vatAmount || 0)) -
//                                                     ((data.totals.salesReturn?.taxableAmount || 0) + (data.totals.salesReturn?.nonVatAmount || 0) + (data.totals.salesReturn?.vatAmount || 0)))}`}>
//                                                     {formatCurrency(((data.totals.sales?.taxableAmount || 0) + (data.totals.sales?.nonVatAmount || 0) + (data.totals.sales?.vatAmount || 0)) -
//                                                         ((data.totals.salesReturn?.taxableAmount || 0) + (data.totals.salesReturn?.nonVatAmount || 0) + (data.totals.salesReturn?.vatAmount || 0)))}
//                                                 </td>
//                                                 <td className="bg-light"></td>
//                                                 <td className="num">{formatCurrency(data.totals.netPurchaseVat)}</td>
//                                                 <td className="num">{formatCurrency(data.totals.netSalesVat)}</td>
//                                                 <td className={`num ${getNetValueClass(data.totals.netVat)}`}>{formatCurrency(data.totals.netVat)}</td>
//                                             </tr>
//                                         ) : null}
//                                     </tbody>
//                                 </table>
        ...
        <div className="monthly-vat-page">
            ...
            <div className="mv-shell">
                ...
                <div className="mv-toolbar">
                    ...
                    {/* WRAPPER FIX: Group button and period together */}
