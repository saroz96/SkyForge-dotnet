                    ...
                    <Card className="p-4">
                        ...
                        <div className="details-container compact-text">
                            ...
                            <div className="right">
                                ...
                                <div><strong>Date:</strong> {adjustmentData.companyDateFormat === 'nepali' ? formatDate(adjustmentData.nepaliDate, 'Nepali') : formatDate(adjustmentData.adjustment.date)}({new Date(adjustmentData.adjustment.date).toLocaleDateString()})</div>
                            </div>
                        </div>
