            ...
            {showAccountModal && (
                <AccountModalForJournal
                    ...
                    onCreateAccount={() => {
                        ...
                        // For journal, you might want to navigate to account creation
                        setShowAccountModal(false);
                        // Navigate to account creation or show creation modal
                        setNotification({
                            show: true,
                    ...
                    autoFocus={false} // ← IMPORTANT: Prevents auto-focus on account rows
