...
const EditSalesQuotation = () => {
    ...
    // Add these after other state declarations (around line 70-80)
    ...
    // Initial data loading - FIXED VERSION
    useEffect(() => {
        const fetchSalesQuotationData = async () => {
            try {
                ...
                console.log("Sales Quotation Data:", data); // Debug log
                ...
                const accountDoc = data.accounts?.find(acc => acc.id === salesQuotation.accountId);
                const accountNameWithNumber = accountDoc?.uniqueNumber
                    ? `${accountDoc.uniqueNumber} ${accountDoc.name}`
                    : salesQuotation.accountName || '';

                // Convert items
                const itemsData = (salesQuotation.items || []).map(item => ({
                ...
                // Set form data with proper date handling
                setFormData({
                    accountId: salesQuotation.accountId || '',
                    accountName: accountNameWithNumber,
                    accountAddress: accountDoc?.address || salesQuotation.accountAddress || '',
                    accountPan: accountDoc?.pan || salesQuotation.accountPan || '',
                    // Use the actual dates from the database
                    transactionDateNepali: formatDate(salesQuotation.transactionDateNepali || salesQuotation.transactionDate),
                    transactionDateRoman: formatDate(salesQuotation.transactionDate || salesQuotation.transactionDateNepali),
                    nepaliDate: formatDate(salesQuotation.nepaliDate || salesQuotation.date),
                    billDate: formatDate(salesQuotation.date || salesQuotation.nepaliDate),
                    billNumber: salesQuotation.billNumber || '',
                    paymentMode: salesQuotation.paymentMode || 'credit',
                    isVatExempt: salesQuotation.isVatExempt ? 'true' :
                        (salesQuotation.isVatAll === 'all' ? 'all' : 'false'),
                    discountPercentage: salesQuotation.discountPercentage || 0,
                    discountAmount: salesQuotation.discountAmount || 0,
                    roundOffAmount: salesQuotation.roundOffAmount || 0,
                    vatPercentage: salesQuotation.vatPercentage || 13,
                    description: salesQuotation.description || '',
                    items: itemsData

                });

                console.log("Sales Quotation Data:", salesQuotation); // Check what fields are available
                console.log("Description field:", salesQuotation.description); // Check the description specifically
                setItems(itemsData);
                ...
                navigate('/retailer/sales-quotation');
                setIsLoading(false);
            }
        };
    ...
    const handleSubmit = async (e, print = false) => {
        ...
        try {
            ...
            // Prepare items for submission - matching backend DTO structure
            ...
            <div class="print-invoice-container">
                ...
                <div class="print-invoice-details">
                    ...
                    <div>
                        ...
                        <div><strong>Validity:</strong> ${printData.companyDateFormat === 'nepali' ? formatDate(printData.bill.transactionDateNepali, 'Nepali') : formatDate(printData.bill.transactionDate)}(${new Date(printData.bill.transactionDate).toLocaleDateString()})</div>
                        <div><strong>Date:</strong> ${printData.companyDateFormat === 'nepali' ? formatDate(printData.bill.nepaliDate, 'Nepali') : formatDate(printData.bill.date)}(${new Date(printData.bill.date).toLocaleDateString()})</div>
    ...
    return (
        <div className="container-fluid">
                        ...
                        <div className="row g-2 mb-3">
                            ...
                            {company.dateFormat === 'nepali' ? (
                                <>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-3">
                                        <div className="position-relative">
                                            ...
                                            <label className="position-absolute" style={{
                                                ...
                                                Validity Periods (BS): <span className="text-danger">*</span>
                                            </label>
                                            {dateErrors.transactionDateNepali && (
                                                <div className="invalid-feedback d-block" style={{ fontSize: '0.7rem' }}>
                                                    {dateErrors.transactionDateNepali}
                                    ...
                                    {/* AD Transaction Date (Validity Periods - Read-only) */}
                                    {/* <div className="col-12 col-md-6 col-lg-3">
                                        <div className="position-relative">
                                            <input
                                                type="text"
                                    ...
                                    <div className="col-12 col-md-6 col-lg-3">
                                        <div className="position-relative">
                                            ...
                                            <label className="position-absolute" style={{
                                                ...
                                                Quotation Date (BS): <span className="text-danger">*</span>
                                            </label>
                                            {dateErrors.nepaliDate && (
                                                <div className="invalid-feedback d-block" style={{ fontSize: '0.7rem' }}>
                                                    {dateErrors.nepaliDate}
                                ...
                                // English date format section (already has 2 fields)
                                <>
                                    <div className="col-12 col-md-6 col-lg-3">
                                        <div className="position-relative">
                                            <input
            ...
            {/* Modals - using the same structure as EditPurcRtn */}
            {showHeaderItemModal && (
                <div
