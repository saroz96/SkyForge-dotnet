...
//                 setFormData({
//                     accountId: salesQuotation.account?.id || '',
//                     accountName: salesQuotation.account?.name || '',
//                     accountAddress: salesQuotation.account?.address || '',
//                     accountPan: salesQuotation.account?.pan || '',
//                     transactionDateNepali: dateFormat === 'nepali' ?
...
//                 nepaliDate: company.dateFormat === 'nepali' ? new Date(formData.nepaliDate).toISOString() : new Date().toISOString(),
//                 date: company.dateFormat !== 'nepali' ? new Date(formData.billDate).toISOString() : new Date().toISOString(),
//                 transactionDateNepali: company.dateFormat === 'nepali' ? new Date(formData.transactionDateNepali).toISOString() : new Date().toISOString(),
//                 transactionDate: company.dateFormat !== 'nepali' ? new Date(formData.transactionDateRoman).toISOString() : new Date().toISOString(),
...
//             {/* Modals - using the same structure as AddSalesQuotation */}
//             {showHeaderItemModal && (
//                 <div
//                     className="modal fade show"
//                     id="headerItemModal"
