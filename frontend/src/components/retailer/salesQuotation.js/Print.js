                    ...
                    <Card className="p-4">
                        ...
                        <div className="details-container compact-text">
                            ...
                            <div className="right">
                                ...
                                <div><strong>Validity:</strong> {quotationData.companyDateFormat === 'nepali' ? formatDate(quotationData.bill.transactionDateNepali, 'Nepali') : formatDate(quotationData.bill.transactionDate)}({new Date(quotationData.bill.transactionDate).toLocaleDateString()})</div>
                                <div><strong>Date:</strong> {quotationData.companyDateFormat === 'nepali' ? formatDate(quotationData.bill.nepaliDate, 'Nepali') : formatDate(quotationData.bill.date)}({new Date(quotationData.bill.date).toLocaleDateString()})</div>
                        ...
                        <div className="total-table">
                            <table className="table table-sm border-0">
                                <tbody>
                                    ...
                                    {!quotationData.bill.isVatExempt && quotationData.company?.vatEnabled !== false && (
                                        <>
                                            <tr>
