...
//             try {
//                 const response = await api.get('/api/retailer/sales-quotation/finds', {
//                     withCredentials: true
//                 });
...
//             const response = await axios.get('/api/retailer/sales-quotation/edit/billNumber', {
//                 params: { billNumber },
//                 withCredentials: true
//             });
...
//                 navigate(`/retailer/sales-quotation/edit/${response.data.data.salesQuotation._id}`);
//             } else {
//                 setError(response.data.error || 'Quotation not found');
//             }
//         } catch (err) {
//             setError(err.response?.data?.error || 'An error occurred while fetching quotation');
...
//                                 Please enter a valid voucher number to find the quotation.
//                             </small>
//                             {error && (
...
//                             id="findBill"
//                         >
//                             {isLoading ? 'Searching...' : 'Find Sales Quotation'}
//                         </button>
//                     </form>
//                 </div>
//             </div>
...
//     );
// };
// export default SalesQuotationVoucherNumber;
...
const SalesQuotationVoucherNumber = () => {
    ...
    const handleFindSalesQuotation = async (e) => {
        e.preventDefault();
        setError('');
        ...
        try {
            ...
            const response = await api.get('/api/retailer/sales-quotation/find-party', {
    ...
    const handleChangeParty = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await api.put(`/api/retailer/sales-quotation/change-party/${billNumber}`, {
    ...
    const handleGoToEditPage = async () => {
        ...
        try {
            ...
            const response = await api.get('/api/retailer/sales-quotation/get-id-by-number', {
                params: { billNumber: billNumber }
            });

            if (response.data.success) {
                // Navigate to edit page with GUID ID
                navigate(`/retailer/sales-quotation/edit/${response.data.data.id}`);
            } else {
    ...
    return (
        <div className='Container-fluid'>
            ...
            <div className="container mt-5 wow-form centered-container">
                <div className="card shadow-lg p-4 animate__animated animate__fadeInUp expanded-card">
                    <h1 className="text-center mb-4">Enter Sales Quotation Voucher Number</h1>
                    ...
                    <form onSubmit={handleFindSalesQuotation} className="needs-validation" noValidate>
                        <div className="form-group">
                            ...
                            <small id="billHelp" className="form-text text-muted">
                                Enter voucher number to find and edit sales quotation
                            </small>
                        </div>
                        ...
                        <button
                            ...
                            onClick={handleFindSalesQuotation}
