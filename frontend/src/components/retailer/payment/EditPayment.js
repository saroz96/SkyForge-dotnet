...
//             try {
//                 await api.post(`/api/retailer/payments/cancel/${formData.billNumber}`);
//                 setNotification({
//                     show: true,
...
//             try {
//                 await api.post(`/api/retailer/payments/reactivate/${formData.billNumber}`);
//                 setNotification({
//                     show: true,
...
//                                                         paddingTop: '0.75rem',
//                                                         width: '100%',
//                                                         backgroundColor: formData.status === 'Canceled' ? '#e9ecef' : '#f8f9fa',
//                                                         cursor: 'not-allowed'
//                                                     }}
//                                                 />
//                                                 <label className="position-absolute" style={{
    ...
    useEffect(() => {
        const fetchPaymentData = async () => {
            try {
                ...
                // Get the nepali date from payment
                const nepaliDateStr = payment.nepaliDate || currentNepaliDate;
                const adDateStr = formatDate(payment.date) || new Date().toISOString().split('T')[0];
                ...
                if (debitEntry?.accountId) {
                    setSelectedAccountId(debitEntry.accountId);
                }
