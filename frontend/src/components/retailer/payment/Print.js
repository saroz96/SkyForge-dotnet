                ...
                <Container fluid>
                    ...
                    <Card className="p-4">
                        ...
                        <div className="details-container compact-text">
                            ...
                            <div className="right">
                                <div><strong>Date:</strong> {paymentData.companyDateFormat === 'nepali' ? formatDate(payment.nepaliDate, 'Nepali') : formatDate(payment.date)}({new Date(payment.date).toLocaleDateString()})</div>
                            </div>
                        </div>
