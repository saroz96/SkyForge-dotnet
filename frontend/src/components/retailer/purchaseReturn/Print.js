...
const PurchaseReturnPrint = () => {
    ...
    useEffect(() => {
        const fetchBillData = async () => {
            try {
                setLoading(true);
                const response = await api.get(`/api/retailer/purchase-return/${id}/print`);
    ...
    const printBill = () => {
        ...
        printWindow.document.write(`
            <html>
                <head>
                    <title>Purchase_Return_${billData.bill.billNumber}</title>
                    <style>${styles}</style>
                </head>
                <body>
    ...
    const generatePdf = async () => {
        ...
        try {
            ...
            pdf.save(`Purchase_Return_${billData.bill.billNumber}.pdf`);
        ...
        <>
            <style id="printStyles">
                ...
                @media print {
                    ...
                    /* Fixed column widths for print - Purchase Return specific */
                ...
                @media screen {
                    ...
                    /* Compact column widths for screen - Purchase Return specific */
                ...
                <Container fluid>
                    ...
                    <Card className="p-4">
                        <div className="header compact-text">
                            ...
                            <h2 className="compact-text">PURCHASE RETURN</h2>
                        </div>
                        <br />
                        <div className="details-container compact-text">
                            ...
                            <div className="right">
                                ...
                                <div><strong>Voucher Date:</strong> {billData.companyDateFormat === 'Nepali' ? formatDate(billData.nepaliDate, 'nepali') : formatDate(billData.bill.date)}</div>
                            </div>
                        </div>
                        ...
                        <div className="signature-area">
                            ...
                            <div className="signature-box">Approved By</div>
                        </div>
                    </Card>
                </Container>
            </div>
            ...
            <div id="printableContent" className="print-version" ref={printableRef}>
                <div className="print-invoice-container">
                    <div className="print-invoice-header">
                        ...
                        <div className="print-invoice-title">PURCHASE RETURN</div>
                    </div>
