...
const PurchaseReturnVoucherNumber = () => {
    ...
    const handleFindPurchaseReturn = async (e) => {
        e.preventDefault();
        setError('');
        ...
        try {
            ...
            const response = await api.get('/api/retailer/purchase-return/find-party', {
    ...
    const handleChangeParty = async () => {
        ...
        setIsLoading(true);
        try {
            const response = await api.put(`/api/retailer/purchase-return/change-party/${billNumber}`, {
    ...
    const handleGoToEditPage = async () => {
        ...
        try {
            ...
            const response = await api.get('/api/retailer/purchase-return/get-id-by-number', {
                params: { billNumber: billNumber }
            });

            if (response.data.success) {
                // Navigate to edit page with GUID ID
                navigate(`/retailer/purchase-return/edit/${response.data.data.id}`);
            } else {
        ...
        <div className='Container-fluid'>
            ...
            <div className="container mt-5 wow-form centered-container">
                <div className="card shadow-lg p-4 animate__animated animate__fadeInUp expanded-card">
                    <h1 className="text-center mb-4">Enter Purchase Return Voucher Number</h1>
                    ...
                    <form onSubmit={handleFindPurchaseReturn} className="needs-validation" noValidate>
                        <div className="form-group">
                            ...
                            <small id="billHelp" className="form-text text-muted">
                                Enter voucher number to find and edit purchase return
                            </small>
                        </div>
                        ...
                        <button
                            ...
                            onClick={handleFindPurchaseReturn}
