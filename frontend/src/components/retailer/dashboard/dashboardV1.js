...
const DashboardV1 = () => {
    ...
    // ✅ StatsCards ref for manual refresh if needed
    ...
    // ✅ Get company ID and fiscal year for child components
    const companyId = getCompanyId();
    const companyName = currentCompany?.name || currentCompany?.Name;
    const fiscalYearJson = getFiscalYearForApi();
        ...
        <div style={styles.container}>
            ...
            <div style={styles.mainLayout}>
                ...
                <div style={styles.contentArea}>
                    {/* Stats Cards - Only for cash, sales, bank, inventory */}
                    <div style={styles.statsGrid}>
                        <StatsCards
                            ref={statsCardsRef}
                            companyId={companyId}
                            companyName={companyName}
                            fiscalYearJson={fiscalYearJson}
                            onRefreshComplete={() => {
                                console.log('✅ StatsCards refresh complete');
                            }}
                        />
                    </div>
                    ...
                    {/* ✅ Top Items & Top Customers Cards - Fetch their own data independently */}
                    <div style={styles.topItemsGrid}>
                        {/* Left: Top Items Card - Self-contained data fetching */}
                        ...
                        {/* Right: Top Customers Card - Self-contained data fetching */}
                        <div style={{ height: '100%' }}>
                            <TopCustomersCard
                                companyId={companyId}
                                companyName={companyName}
...
//     // Sidebar menu items with nested submenus
//     const menuItems = [
//         { 
//             key: 'dashboard', 
//             icon: <FaHome size={20} />, 
...
//     const managementItems = [
//         { key: 'attendance', icon: <FaCalendarCheck size={20} />, label: 'Attendance', path: '/attendance' },
//         { key: 'store', icon: <FaStore size={20} />, label: 'Store', path: '/retailer/store' },
//         { key: 'suppliers', icon: <FaTruck size={20} />, label: 'Suppliers', path: '/retailer/suppliers' },
//     ];

//     const handleMenuItemClick = (item) => {
//         if (item.path) {
//             setActiveMenu(item.key || item.label);
//             navigate(item.path);
//         }
...
//     // ... [rest of the initialization code remains the same - keep all the existing useEffect, fetch functions, etc.]
...
//     // [Keep all the loading, error, and auth checks as they were]
...
//                                     (item.submenu && item.submenu.some(sub => sub.key === activeMenu));

//                                 return (
//                                     <div key={index} className="dashboard-sidebar-item-wrapper">
//                                         <div
...
//                                             }}
//                                         >
//                                             {isActive && <div className="dashboard-sidebar-item-active-before" />}
//                                             <span className="dashboard-sidebar-item-icon">
//                                                 {item.icon}
//                                             </span>
//                                             <span className="dashboard-sidebar-item-label">{item.label}</span>
//                                             {item.badge && (
//                                                 <span className={`dashboard-sidebar-item-badge ${item.badge === 'New' ? 'badge-orange' : ''}`}>
//                                                     {item.badge}
//                                                 </span>
//                                             )}
//                                             {hasSubmenu && (
//                                                 <span className="dashboard-sidebar-item-chevron">
...
//                                                         <div
//                                                             key={subIndex}
//                                                             className={`dashboard-sidebar-submenu-item ${isSubActive ? 'active' : ''}`}
//                                                             onClick={(e) => {
//                                                                 e.stopPropagation();
...
//                                                             }}
//                                                         >
//                                                             <span className="dashboard-sidebar-submenu-item-icon">
//                                                                 {subItem.icon}
//                                                             </span>
//                                                             <span className="dashboard-sidebar-submenu-item-label">
//                                                                 {subItem.label}
//                                                             </span>
//                                                         </div>
//                                                     );
...
//                                 <div
//                                     key={index}
//                                     className={`dashboard-sidebar-item ${activeMenu === item.key ? 'active' : ''}`}
//                                     onClick={() => handleMenuItemClick(item)}
//                                     onMouseEnter={(e) => {
...
//                                     }}
//                                 >
//                                     {activeMenu === item.key && <div className="dashboard-sidebar-item-active-before" />}
//                                     <span className="dashboard-sidebar-item-icon">
//                                         {item.icon}
//                                     </span>
//                                     <span className="dashboard-sidebar-item-label">{item.label}</span>
...
//                                 <p className="dashboard-sidebar-user-email">{currentUser?.email || 'user@company.com'}</p>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
...
//                     {/* Chart, Pie Chart and Quick Actions */}
//                     <div className="dashboard-content-grid">
//                         <div className="dashboard-content-grid-item">
//                             <SalesChart
//                                 companyId={companyId}
//                                 companyName={companyName}
//                                 fiscalYearJson={fiscalYearJson}
...
//                         <div className="dashboard-content-grid-item quick-actions-wrapper">
//                             <QuickActions
//                                 onPosSaleClick={handlePosSaleClick}
//                                 companyId={companyId}
//                             />
...
//                     <div className="dashboard-top-items-grid">
//                         <div className="dashboard-top-items-grid-item">
//                             <TopItemsCard
//                                 companyId={companyId}
//                                 companyName={companyName}
//                                 fiscalYearJson={fiscalYearJson}
