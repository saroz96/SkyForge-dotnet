...
const DashboardV1 = () => {
    ...
    // ============================================
    const styles = {
        // Outer container — flex row: sidebar + right column
        container: {
            display: 'flex',
            flexDirection: 'row',
            minHeight: '100vh',
    ...
    return (
        <div style={styles.container}>
            {/* ✅ Sidebar — full height, sits on the LEFT of everything */}
            <RetailerSidebar currentUser={currentUser} />

            {/* ✅ Right side — header + content stacked vertically */}
            <div style={styles.rightSide}>
                {/* Header — now starts to the RIGHT of the sidebar */}
                <div style={styles.headerWrapper}>
                    <Header />
                </div>
