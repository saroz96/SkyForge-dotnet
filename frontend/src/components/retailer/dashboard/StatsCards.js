...
//             if (response.data.success) {
//                 const { financialSummary, topItemsByTransaction, topItemsByRevenue, topItemsByFrequency } = response.data.data;
...
//                 // ✅ CRITICAL: Call the callback with the full dashboard data
//                 if (onDataLoaded) {
//                     console.log('📤 StatsCards calling onDataLoaded with top items:', {
...
//             setIsFetching(false);
//         }
//     }, [companyId, companyName, fiscalYearJson, statsCardDraftSave, setStatsCardDraftSave, API_BASE_URL, isFetching, onDataLoaded]);
    ...
    const fetchFreshData = useCallback(async (isBackground = false) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                // ✅ CRITICAL: Call the callback with ALL dashboard data
                if (onDataLoaded) {
