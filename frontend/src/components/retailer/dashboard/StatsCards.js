...
//             value: displayData.cashBalance,
//             icon: 'bi-cash-coin',
//             iconClass: 'sc-icon--cash',
//             bgClass: 'sc-card--cash',
//             onClick: () => { setSelectedAccountId(null); setShowCashModal(true); },
//             subtext: 'Available cash'
//         },
//         {
...
//             value: displayData.netSales,
//             icon: 'bi-graph-up-arrow',
//             iconClass: 'sc-icon--sales',
//             bgClass: 'sc-card--sales',
//             onClick: () => { setSelectedAccountId(null); setShowSalesModal(true); },
//             subtext: "Today's sales"
//         },
//         {
...
//             value: displayData.bankBalance,
//             icon: 'bi-bank',
//             iconClass: 'sc-icon--bank',
//             bgClass: 'sc-card--bank',
//             onClick: () => { setShowBankModal(true); },
//             subtext: 'Total in bank'
//         },
//         {
...
//             value: displayData.totalStock,
//             icon: 'bi-box-seam',
//             iconClass: 'sc-icon--inventory',
//             bgClass: 'sc-card--inventory',
//             onClick: () => { setShowInventoryModal(true); },
//             subtext: 'Stock value'
//         }
//     ];
...
//                     <div
//                         key={config.key}
//                         className={`sc-card ${config.bgClass}`}
//                         onClick={config.onClick}
//                     >
//                         <div className="sc-card-header">
//                             <span className="sc-card-label">{config.label}</span>
//                             <div className={`sc-card-icon ${config.iconClass}`}>
...
//                             >
//                                 Rs. {formatCurrency(config.value)}
//                             </span>
//                             <span className="sc-card-subtext">
//                                 <i className="bi bi-arrow-right me-1"></i>
//                                 {config.subtext}
//                             </span>
//                         </div>
