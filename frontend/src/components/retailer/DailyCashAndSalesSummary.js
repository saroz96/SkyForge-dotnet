// // src/components/retailer/dashboard/modals/CashModal.jsx
...
// const DailyCashAndSalesSummary = ({ show, onClose, companyId, accountId }) => {
...
//                     totalCashReturns: data.totalCashReturns || 0,
...
//                                         <h6 className="text-muted mb-0 small">Total Cash Sales</h6>
//                                         <h5 className="mb-0 text-success">
//                                             Rs. {formatCurrency(cashData.totalCashSales)}
//                                         </h5>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                     <div className="card-body py-2 px-3">
//                                         <h6 className="text-muted mb-0 small">Total Cash Returns</h6>
//                                         <h5 className="mb-0 text-danger">
//                                             Rs. {formatCurrency(cashData.totalCashReturns)}
//                                         </h5>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                             cashData.transactions.map((transaction, index) => (
//                                                 <tr key={index}>
//                                                     <td style={{ fontSize: '0.75rem' }}>
//                                                         {transaction.nepaliDate || transaction.date?.split('T')[0] || 'N/A'}
//                                                     </td>
//                                                     <td style={{ fontSize: '0.75rem' }}>{transaction.billNumber || 'N/A'}</td>
//                                                     <td style={{ fontSize: '0.75rem' }}>
//                                                         {transaction.accountName || transaction.cashAccount || 'N/A'}
//                                                     </td>
//                                                     <td style={{ fontSize: '0.75rem' }}>
//                                                         <span className={`badge ${transaction.type === 'Sale' ? 'bg-success' : 'bg-warning'}`}>
...
// export default DailyCashAndSalesSummary;

//-------------------------------------------------------------end

// src/components/retailer/dashboard/modals/DailyCashAndSalesSummary.jsx
