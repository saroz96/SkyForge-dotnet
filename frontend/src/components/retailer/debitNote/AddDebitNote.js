...
//                     </thead>
//                     <tbody>
//                         ${printData.debitNote.debitAccounts.map((account, index) => `
//                             <tr>
//                                 <td>${index + 1}</td>
...
//                             </tr>
//                         `).join('')}
//                         ${printData.debitNote.creditAccounts.map((account, index) => `
//                             <tr>
//                                 <td>${printData.debitNote.debitAccounts.length + index + 1}</td>
//                                 <td>${account.account?.name || 'N/A'}</td>
//                                 <td>0.00</td>
...
//                             <th>${printData.debitNote.debitAccounts.reduce((sum, acc) => sum + (acc.debit || 0), 0).toFixed(2)}</th>
//                             <th>${printData.debitNote.creditAccounts.reduce((sum, acc) => sum + (acc.credit || 0), 0).toFixed(2)}</th>
//                         </tr>
//                     </tfoot>
//                 </table>
...
//                         <h5 className="card-title mb-0">Debit Note Entry</h5>
//                     </div>
