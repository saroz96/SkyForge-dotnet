...
//             tableContent += `
//             <tr>
//                 <td class="nowrap">${debitNote.nepaliDate ? new NepaliDate(debitNote.nepaliDate).format('YYYY-MM-DD') : ''}</td>
...
//                         {debitNote.nepaliDate ? new NepaliDate(debitNote.nepaliDate).format('YYYY-MM-DD') : ''}
//                     </span>
//                 </div>
