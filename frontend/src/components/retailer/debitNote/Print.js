                ...
                <Container fluid>
                    ...
                    <Card className="p-4">
                        ...
                        <div className="details-container compact-text">
                            ...
                            <div className="right">
                                <div><strong>Date:</strong> {debitNoteData.companyDateFormat === 'nepali' ? formatDate(debitNote.nepaliDate, 'Nepali') : formatDate(debitNote.date)}({new Date(debitNote.date).toLocaleDateString()})</div>
                            </div>
                        </div>
