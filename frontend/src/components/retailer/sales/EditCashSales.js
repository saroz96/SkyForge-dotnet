...
//                     setFormData({
//                         cashAccount: billData.cashAccount || '',
//                         cashAccountAddress: billData.cashAccountAddress || '',
//                         cashAccountPan: billData.cashAccountPan || '',
//                         cashAccountEmail: billData.cashAccountEmail || '',
//                         cashAccountPhone: billData.cashAccountPhone || '',
//                         transactionDateNepali: new NepaliDate(billData.transactionDate).format('YYYY-MM-DD') || currentNepaliDate,
//                         transactionDateRoman: new Date(billData.transactionDate).toISOString().split('T')[0] || new Date().toISOString().split('T')[0],
//                         nepaliDate: new NepaliDate(billData.date).format('YYYY-MM-DD') || currentNepaliDate,
//                         billDate: new Date(billData.date).toISOString().split('T')[0] || new Date().toISOString().split('T')[0],
//                         billNumber: billData.billNumber,
//                         paymentMode: billData.paymentMode || 'cash',
//                         isVatExempt: billData.isVatExempt ? 'true' : (billData.isVatAll ? 'all' : 'false'),
//                         discountPercentage: billData.discountPercentage || 0,
//                         discountAmount: billData.discountAmount || 0,
//                         roundOffAmount: Math.round(billData.roundOffAmount * 100) / 100 || 0,
//                         vatPercentage: billData.vatPercentage || 13,
//                         subTotal: billData.subTotal || 0,
//                         taxableAmount: billData.taxableAmount || 0,
//                         vatAmount: billData.vatAmount || 0,
//                         totalAmount: billData.totalAmount || 0
//                     });

//                     const processedItems = data.data.bill.items.map(item => ({
//                         item: item.item || 'N/A',
...
//                     setNotification({
//                         show: true,
//                         message: data.error || 'Failed to load bill data',
//                         type: 'error'
//                     });
//                 }
//             } catch (error) {
...
//                 setNotification({
//                     show: true,
//                     message: 'Error loading bill data',
//                     type: 'error'
//                 });
//             } finally {
//                 setIsLoading(false);
...
//                                     autoFocus
//                                     autoComplete='off'
//                                     value={formData.cashAccount} // Bind to formData.cashAccount for typing
//                                     onChange={(e) => {
//                                         const value = e.target.value;
...
//                                             ...prev,
//                                             cashAccount: value,
//                                             cashAccountId: '', // Clear ID when typing
//                                             cashAccountAddress: '', // Clear other fields
//                                             cashAccountPan: '',
//                                             cashAccountEmail: '',
//                                             cashAccountPhone: ''
//                                         }));
...
//                                         } else if (e.key === 'Enter') {
//                                             e.preventDefault();
//                                             // Check if we should select an existing account or use typed text
//                                             const firstAccountItem = document.querySelector('.account-item.active');
//                                             if (firstAccountItem) {
//                                                 // Select existing account if one is active
...
//                                                 // Update form data with selected account
//                                                 setFormData(prev => ({
//                                                     ...prev,
//                                                     cashAccount: account.name,
//                                                     cashAccountId: account._id,
...
//                                                     // Clear account ID since this is a typed account
//                                                     setFormData(prev => ({
//                                                         ...prev,
//                                                         cashAccountId: '',
//                                                         cashAccountAddress: '',
