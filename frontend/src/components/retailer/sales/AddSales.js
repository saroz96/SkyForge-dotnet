...
//     // The JSX remains largely the same as your original AddSales.js, but with updated property names
//     // and matching the structure of AddPurcRtn.js

//     // Since the JSX is very long, I'll provide the key parts that need to be updated:
