...
const VoucherConfiguration = () => {
    ...
    const fetchAllDatePreferences = async () => {
        try {
            ...
            const stockAdjustmentPrefResponse = await api.get('/api/retailer/date-preference/stock-adjustment');
            if (stockAdjustmentPrefResponse.data.success) { // Fixed: was checking creditNotePrefResponse
                setSettings(prev => ({
                    ...prev,
                    datePreferenceStockAdjustment: stockAdjustmentPrefResponse.data.data.useVoucherLastDate || false
                }));
    ...
    const DatePreferenceRadio = ({ type, label, value, disabled }) => (
        <div className="vc-radio-group">
            <div className="vc-radio-option">
                <input
                    type="radio"
                    className="vc-radio-input"
                    name={type}
                    id={`${type}_system`}
                    checked={!value}
                    onChange={() => updateDatePreference(type, false)}
                    disabled={disabled}
                />
                <label className="vc-radio-label" htmlFor={`${type}_system`}>
                    System Date
                </label>
            </div>
            <div className="vc-radio-option">
                <input
                    ...
                    disabled={disabled}
                />
                <label className="vc-radio-label" htmlFor={`${type}_voucher`}>
                    Voucher Last Date
                </label>
            </div>
            {disabled && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
        </div>
    );
            ...
            <div className="vc-page">
                ...
                <div className="vc-shell">
                    <div className="vc-state">
                        ...
                        <p className="mt-3" style={{ fontSize: '0.85rem', color: '#64748b' }}>Loading configuration...</p>
                    </div>
                </div>
            </div>
        );
                ...
                <div className="vc-main">
                    ...
                    <div className="vc-section">
                        <div className="vc-section-header">
                            <i className="bi bi-calculator vc-section-icon"></i>
                            <h3>Round-Off Settings</h3>
                        </div>
                            ...
                            <div className="vc-card">
                                <div className="vc-card-content">
                                    <input
                                        ...
                                        disabled={isSaving.roundOffSales}
                                    />
                                    <label className="vc-checkbox-label" htmlFor="roundOffSales">
                                        Round Off Sales
                                    </label>
                                    {isSaving.roundOffSales && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
                                </div>
                            </div>
                            ...
                            <div className="vc-card">
                                <div className="vc-card-content">
                                    <input
                                        ...
                                        disabled={isSaving.roundOffSalesReturn}
                                    />
                                    <label className="vc-checkbox-label" htmlFor="roundOffSalesReturn">
                                        Round Off Sales Return
                                    </label>
                                    {isSaving.roundOffSalesReturn && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
                                </div>
                            </div>
                            ...
                            <div className="vc-card">
                                <div className="vc-card-content">
                                    <input
                                        ...
                                        disabled={isSaving.roundOffPurchase}
                                    />
                                    <label className="vc-checkbox-label" htmlFor="roundOffPurchase">
                                        Round Off Purchase
                                    </label>
                                    {isSaving.roundOffPurchase && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
                                </div>
                            </div>
                            ...
                            <div className="vc-card">
                                <div className="vc-card-content">
                                    <input
                                        ...
                                        disabled={isSaving.roundOffPurchaseReturn}
                                    />
                                    <label className="vc-checkbox-label" htmlFor="roundOffPurchaseReturn">
                                        Round Off Purchase Return
                                    </label>
                                    {isSaving.roundOffPurchaseReturn && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="vc-section">
                        <div className="vc-section-header">
                            <i className="bi bi-desktop vc-section-icon"></i>
                            ...
                            <div className="vc-card">
                                <div className="vc-card-content">
                                    <input
                                        ...
                                        disabled={isSaving.displayTransactions}
                                    />
                                    <label className="vc-checkbox-label" htmlFor="displayTransactions">
                                        Show Transactions in Sales
                                    </label>
                                    {isSaving.displayTransactions && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
                                </div>
                            </div>
                            ...
                            <div className="vc-card">
                                <div className="vc-card-content">
                                    <input
                                        ...
                                        disabled={isSaving.displayTransactionsForSalesReturn}
                                    />
                                    <label className="vc-checkbox-label" htmlFor="displayTransactionsForSalesReturn">
                                        Show Transactions in Sales Return
                                    </label>
                                    {isSaving.displayTransactionsForSalesReturn && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
                                </div>
                            </div>
                            ...
                            <div className="vc-card">
                                <div className="vc-card-content">
                                    <input
                                        ...
                                        disabled={isSaving.displayTransactionsForPurchase}
                                    />
                                    <label className="vc-checkbox-label" htmlFor="displayTransactionsForPurchase">
                                        Show Transactions in Purchase
                                    </label>
                                    {isSaving.displayTransactionsForPurchase && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
                                </div>
                            </div>
                            ...
                            <div className="vc-card">
                                <div className="vc-card-content">
                                    <input
                                        ...
                                        disabled={isSaving.displayTransactionsForPurchaseReturn}
                                    />
                                    <label className="vc-checkbox-label" htmlFor="displayTransactionsForPurchaseReturn">
                                        Show Transactions in Purchase Return
                                    </label>
                                    {isSaving.displayTransactionsForPurchaseReturn && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="vc-section">
                        <div className="vc-section-header">
                            <i className="bi bi-calendar-date vc-section-icon"></i>
                            <h3>Date Preference Settings</h3>
                        </div>
                        <div className="vc-grid">
                            {/* Purchase Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Purchase Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferencePurchase"
                                    label="Purchase"
                                    value={settings.datePreferencePurchase}
                            ...
                            {/* Sales Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Sales Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferenceSales"
                                    label="Sales"
                                    value={settings.datePreferenceSales}
                            ...
                            {/* Sales Return Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Sales Return Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferenceSalesReturn"
                                    label="Sales Return"
                                    value={settings.datePreferenceSalesReturn}
                            ...
                            {/* Purchase Return Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Purchase Return Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferencePurchaseReturn"
                                    label="Purchase Return"
                                    value={settings.datePreferencePurchaseReturn}
                            ...
                            {/* Payment Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Payment Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferencePayment"
                                    label="Payment"
                                    value={settings.datePreferencePayment}
                            ...
                            {/* Receipt Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Receipt Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferenceReceipt"
                                    label="Receipt"
                                    value={settings.datePreferenceReceipt}
                            ...
                            {/* Journal Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Journal Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferenceJournal"
                                    label="Journal"
                                    value={settings.datePreferenceJournal}
                            ...
                            {/* Debit Note Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Debit Note Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferenceDebitNote"
                                    label="Debit Note"
                                    value={settings.datePreferenceDebitNote}
                            ...
                            {/* Credit Note Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Credit Note Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferenceCreditNote"
                                    label="Credit Note"
                                    value={settings.datePreferenceCreditNote}
                            ...
                            {/* Sales Quotation Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Sales Quotation Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferenceSalesQuotation"
                                    label="Sales Quotation"
                                    value={settings.datePreferenceSalesQuotation}
                            ...
                            {/* Stock Adjustment Date Preference */}
                            <div className="vc-card vc-card--radio">
                                <div className="vc-card-label">Stock Adjustment Entry</div>
                                <DatePreferenceRadio
                                    type="datePreferenceStockAdjustment"
                                    label="Stock Adjustment"
                                    value={settings.datePreferenceStockAdjustment}
                    ...
                    <div className="vc-section">
                        <div className="vc-section-header">
                            <i className="bi bi-shop vc-section-icon"></i>
                            ...
                            <div className="vc-card">
                                <div className="vc-card-content">
                                    <input
                                        ...
                                        disabled={isSaving.storeManagement}
                                    />
                                    <label className="vc-checkbox-label" htmlFor="storeManagement">
                                        Enable Store/Rack Management
                                    </label>
                                    {isSaving.storeManagement && <span className="vc-saving-spinner spinner-border spinner-border-sm ms-2" role="status" />}
                                </div>
                            </div>
                        </div>
                    </div>
