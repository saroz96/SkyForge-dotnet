...
const PurchaseVatReport = () => {
    ...
    const exportToExcel = async () => {
        ...
        try {
            ...
            const headers = [
                'Date', 'Vch. No.', 'Supplier\'s Bill No.', 'Supplier\'s Name', 'Supplier\'s PAN',
            ...
            ws['!cols'] = [
                { wch: 12 }, { wch: 14 }, { wch: 14 }, { wch: 25 }, { wch: 12 },
            ...
            const fileName = `Purchase_VAT_Report_${data.fromDate}_to_${data.toDate}.xlsx`;
            ...
            <table cellspacing="0">
                ...
                <tfoot>
                    <tr class="total-row">
                        ...
                        <td class="text-end"><strong>${formatCurrency(totals.nonVatPurchase)}</strong></td>
    ...
    const TableHeader = React.memo(() => {
        const totalWidth = columnWidths.date + columnWidths.voucherNo + columnWidths.supplierBillNo +
            columnWidths.supplierName + columnWidths.panNumber + columnWidths.totalAmount +
            columnWidths.discount + columnWidths.nonVatPurchase + columnWidths.taxableAmount + columnWidths.vatAmount;
                    ...
                    <div className="row g-2 mb-3">
                        ...
                        <div className="col-12 col-md-auto d-flex align-items-end justify-content-end gap-2">
                            <button
                                ...
                                disabled={data.purchaseVatReport.length === 0 || exporting}
                                style={{ height: '30px', fontSize: '0.8rem', padding: '0 12px', fontWeight: '500', whiteSpace: 'nowrap' }}
                            >
                        ...
                        <>
                            ...
                            {filteredReports.length > 0 && (
                                <div className="d-flex bg-light border-top sticky-bottom" style={{ zIndex: 2, height: '28px', borderTop: '2px solid #dee2e6' }}>
                                    <div className="d-flex align-items-center px-1" style={{ width: `${columnWidths.date + columnWidths.voucherNo + columnWidths.supplierBillNo + columnWidths.supplierName + columnWidths.panNumber}px`, flexShrink: 0, height: '100%' }}>
