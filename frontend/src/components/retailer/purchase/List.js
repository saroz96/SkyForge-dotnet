...
const PurchaseBillsList = () => {
                ...
                if (response.data.success) {
                    ...
                    if (!hasDraftDates && currentFiscalYear) {
                        ...
                        if (isNepaliFormat) {
                            ...
                            fromDateFormatted = currentFiscalYear.startDateNepali || '';
                            toDateFormatted = currentNepaliDate;

                            // If no Nepali dates in fiscal year, use current date
                            if (!fromDateFormatted) {
                                fromDateFormatted = currentNepaliDate;
                            }
                        } else {
    ...
    const TableHeader = React.memo(() => {
        ...
        const totalWidth = columnWidths.date + columnWidths.vchNo + columnWidths.invNo + columnWidths.supplierName +
        ...
        return (
            ...
            >
                ...
                >
                    <strong style={{ fontSize: '0.75rem' }}>Suppliers Name</strong>
                    <ResizeHandle
                        onResizeStart={handleResizeStart}
    ...
    const TableRow = React.memo(({ index, style, data: rowData }) => {
        ...
        return (
            ...
            >
                ...
                >
                    <span style={{ fontSize: '0.75rem' }}>
                        {bill.discountPercentage?.toFixed(2)}% - {formatCurrency(bill.discountAmount)}
                    </span>
                </div>
                        ...
                        <>
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        width: `${columnWidths.date + columnWidths.vchNo + columnWidths.invNo + columnWidths.supplierName + columnWidths.payMode}px`,
                                        flexShrink: 0,
                                        height: '100%'
                                    }}
                                >
