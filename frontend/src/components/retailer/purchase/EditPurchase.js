...
//             fetchItemsFromBackend(searchTerm, 1);
//         }
...
//                     } : null,
//                     amount: (item.quantity * item.puPrice).toFixed(2),
//                     uniqueUuId: item.uniqueUuId, // Add uniqueUuId
//                     store: item.store || null,
//                     rack: item.rack || null,
//                     price: item.price || 0,
//                     mrp: item.mrp || 0,
...
//             isVatable: fullItem.vatStatus === 'vatable'
//         });
...
//         if (isHeaderMode) {
//             // Handle header mode - insert new item with sales price
...
//         } else {
//             // Handle table row mode - update existing item
...
//         };
//     }, [showTransactionModal, showAccountCreationModal, showAccountModal, showSalesPriceModal, handleTransactionModalClose]);
...
//             fetchItemsFromBackend(headerSearchQuery, headerSearchPage + 1);
//         }
//     };
...
//                 fetchItemsFromBackend(headerLastSearchQuery, 1);
//             }
//         }
//     };
...
//                     currency: item.currency || 'NPR',
//                     CCPercentage: parseFloat(item.CCPercentage) || 7.5,
//                     itemCCAmount: parseFloat(item.itemCCAmount) || 0,
...
//                 // Add these backend-required fields:
...
//             console.log('Submitting purchase data:', JSON.stringify(billData, null, 2));
