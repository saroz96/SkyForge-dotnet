                ...
                <Container fluid>
                    ...
                    <Card className="p-4">
                        ...
                        <div className="details-container compact-text">
                            ...
                            <div className="right">
                                <div><strong>Date:</strong> {receiptData.companyDateFormat === 'nepali' ? formatDate(receipt.nepaliDate, 'Nepali') : formatDate(receipt.date)}({new Date(receipt.date).toLocaleDateString()})</div>
                            </div>
                        </div>
