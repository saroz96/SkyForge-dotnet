...
//             <html>
//                 <head>
//                     <title>Sales_Return_${billData.bill.billNumber}</title>
//                     <style>${styles}</style>
//                 </head>
//                 <body>
...
//             pdf.save(`Sales_Return_${billData.bill.billNumber}.pdf`);
...
//                             </h4>
//                             <h2 className="compact-text">SALES RETURN</h2>
//                         </div>
//                         <br />
...
//                             </div>
//                             <div className="right">
//                                 <div><strong>Return No:</strong> {billData.bill.billNumber}</div>
...
//                                 <div><strong>Return Date:</strong> {new Date(billData.bill.date).toLocaleDateString()}</div>
...
const SalesReturnPrint = () => {
    ...
    useEffect(() => {
        const fetchBillData = async () => {
            try {
                setLoading(true);
                const response = await api.get(`/api/retailer/sales-return/${id}/print`);
        ...
        <>
            <style id="printStyles">
                ...
                @media print {
                    ...
                    /* Fixed column widths for print - Sales Return specific */
                    .print-invoice-table th:nth-child(1),
                    .print-invoice-table td:nth-child(1) {
                        width: 4%;
                    }
                ...
                @media screen {
                    ...
                    /* Compact column widths for screen - Sales Return specific */
                    .table th:nth-child(1),
                    .table td:nth-child(1) {
                        width: 4%;
                    }
                        ...
                        <div className="details-container compact-text">
                            <div className="left wrap-text">
                                ...
                                {billData.bill.account ? (
                                    // Credit Sales Return - Display account details
                                    <>
                                        ...
                                        <div><strong>Email:</strong> {billData.bill.account.email || ''}</div>
                                        <div><strong>Phone:</strong> {billData.bill.account.phone || ''}</div>
                                    </>
                                ) : billData.bill.cashAccount ? (
                                    // Cash Sales Return - Display cash account details
                                    <>
                                        ...
                                        <div><strong>Email:</strong> {billData.bill.cashAccountEmail || ''}</div>
                                        <div><strong>Phone:</strong> {billData.bill.cashAccountPhone || ''}</div>
                                    </>
                                ) : (
                            ...
                            <div className="right">
                                ...
                                <div><strong>Org. Inv.:</strong> {billData.bill.originalSalesBillNumber || ''}</div>
                                ...
                                <div><strong>Invoice Issue Date:</strong> {billData.companyDateFormat === 'Nepali' ? formatDate(billData.nepaliDate, 'nepali') : formatDate(billData.bill.date)}</div>
