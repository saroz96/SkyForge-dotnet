...
const CreditSalesReturnVoucherNumber = () => {
    ...
    const [showCashSalesReturnWarning, setShowCashSalesReturnWarning] = useState(false);
    const [cashSalesReturnBillNumber, setCashSalesReturnBillNumber] = useState('');
    ...
    useEffect(() => {
        if (!showPartyModal && !showCashSalesReturnWarning) {
            const timer = setTimeout(() => {
                if (billNumberInputRef.current) {
                    billNumberInputRef.current.focus();
                }
    ...
    }, [showPartyModal, showCashSalesReturnWarning]);
    ...
    const checkBillEditable = async (billNum) => {
        try {
            const response = await api.get('/api/retailer/sales-return/check-editable', {
    ...
    const handleFindCreditSalesReturn = async (e) => {
        e.preventDefault();
        setError('');
        setShowCashSalesReturnWarning(false);
        ...
        try {
            ...
            if (!editableCheck.isEditable) {
                if (editableCheck.hasCashAccount) {
                    ...
                    setCashSalesReturnBillNumber(billNumber);
                    setShowCashSalesReturnWarning(true);
                } else {
    ...
    const handleCloseCashSalesReturnWarning = () => {
        setShowCashSalesReturnWarning(false);
        setCashSalesReturnBillNumber('');
        // Focus back on input
        setTimeout(() => {
            if (billNumberInputRef.current) {
                billNumberInputRef.current.focus();
    ...
    const handleGoToEditPage = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                navigate(`/retailer/sales-return/edit/${response.data.data.id}`);
            } else {
        ...
        <div className='Container-fluid'>
            ...
            <div className="container mt-5 wow-form centered-container">
                <div className="card shadow-lg p-4 animate__animated animate__fadeInUp expanded-card">
                    <h1 className="text-center mb-4">Enter Credit Sales Return Voucher Number</h1>
                    ...
                    <form onSubmit={handleFindCreditSalesReturn} className="needs-validation" noValidate>
                        <div className="form-group">
                            ...
                            <small id="billHelp" className="form-text text-muted">
                                Enter voucher number to find and edit credit sales return
                            </small>
                        </div>
                        ...
                        <button
                            ...
                            onClick={handleFindCreditSalesReturn}
                            ...
                            <div className="modal-content">
                                <div className="modal-header bg-warning text-dark">
                                    <h5 className="modal-title">
                                        ...
                                        Cannot Edit Cash Sales Return
                                    </h5>
                                    <button type="button" className="btn-close" onClick={handleCloseCashSalesReturnWarning}></button>
                                </div>
                                <div className="modal-body text-center py-4">
                                    <i className="bi bi-cash-stack text-warning" style={{ fontSize: '3rem' }}></i>
                                    <h6 className="mt-3">Voucher #{cashSalesReturnBillNumber}</h6>
                                    <p className="mt-2">
                                        This is a cash sales return voucher and cannot be edited as credit sales return.
                                        Cash sales return vouchers are processed through the cash sales return module.
                                    </p>
                                </div>
                                <div className="modal-footer">
                                    <button
                                        ...
                                        onClick={handleCloseCashSalesReturnWarning}
                                    >
                                        OK, Got It
                                    </button>
                                </div>
