...
const CashSalesReturnVoucherNumber = () => {
    ...
    useEffect(() => {
        const fetchLatestBillNumber = async () => {
            try {
                const response = await api.get('/api/retailer/cash/sales-return/finds');
    ...
    const checkBillEditable = async (billNum) => {
        try {
            const response = await api.get('/api/retailer/cash/sales-return/check-editable', {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await api.get('/api/retailer/cash/sales-return/get-id-by-number', {
                params: { billNumber }
            });

            if (response.data.success) {
                // Navigate to edit page with the sales bill ID
                navigate(`/retailer/cash/sales-return/edit/${response.data.data.id}`);
            } else {
        ...
        <div className='Container-fluid'>
            ...
            <div className="container mt-5 wow-form centered-container">
                <div className="card shadow-lg p-4 animate__animated animate__fadeInUp expanded-card">
                    <h1 className="text-center mb-4">Enter Cash Sales Return Voucher Number</h1>
                    ...
                    <form onSubmit={handleSubmit} className="needs-validation" noValidate>
                        <div className="form-group">
                            ...
                            <small id="billHelp" className="form-text text-muted">
                                Enter voucher number to find and edit cash sales return
                            </small>
                        </div>
                            ...
                            <div className="modal-content">
                                <div className="modal-header bg-warning text-dark">
                                    <h5 className="modal-title">
                                        ...
                                        Cannot Edit Credit Sales Return
                                    </h5>
                                ...
                                <div className="modal-body text-center py-4">
                                    ...
                                    <p className="mt-2">
                                        ...
                                        Credit sales return vouchers are processed through the credit sales return module.
                                    </p>
                                </div>
...
export default CashSalesReturnVoucherNumber;