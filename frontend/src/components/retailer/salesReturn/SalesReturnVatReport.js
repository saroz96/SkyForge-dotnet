...
// import './SalesReturnVatReport.css';
...
//             // Header information
//             excelData.push(['Sales Return VAT Report']);
...
//             const headers = [
//                 'S.No', 'Miti', 'Date (AD)', 'Vch. No.', 'Buyer\'s Name',
//                 'Buyer\'s PAN', 'Total Amount', 'Discount', 'Non-VAT Return',
//                 'Taxable Amt.', 'VAT'
//             ];
...
//                     formatCurrencyForExport(report.nonVatSalesReturn),
...
//                 totalNonVatReturn += parseFloat(report.nonVatSalesReturn || 0);
...
//                 formatCurrencyForExport(totalNonVatReturn),
...
//             const fileName = `Sales_Return_VAT_Report_${dateRange.fromDate}_to_${dateRange.toDate}_${currentDate}.xlsx`;
...
//             <html>
//                 <head>
//                     <title>Sales Return VAT Report</title>
//                     <meta charset="UTF-8">
//                     <style>
//                         @page { margin: 5mm; }
//                         body { 
...
//                     <td style="white-space: normal; word-wrap: break-word; max-width: 150px;">${report.accountName || 'Cash Return'}</td>
...
//                     <td class="text-end">${(report.nonVatSalesReturn || 0).toFixed(2)}</td>
...
//                     <td class="text-end total-label">${printTotals.nonVatReturn.toFixed(2)}</td>
...
//             >
//                 {/* BS Date */}
//                 <div className="srv-header-cell srv-header-cell--center" style={{ width: `${columnWidths.bsDate}px`, flexShrink: 0, minWidth: '80px' }}>
//                     <strong>Miti</strong>
//                     <ResizeHandle onResizeStart={handleResizeStart} left={columnWidths.bsDate - 2} columnName="bsDate" />
//                 </div>

//                 {/* AD Date */}
//                 <div className="srv-header-cell srv-header-cell--center" style={{ width: `${columnWidths.adDate}px`, flexShrink: 0, minWidth: '80px' }}>
//                     <strong>Date</strong>
//                     <ResizeHandle onResizeStart={handleResizeStart} left={columnWidths.adDate - 2} columnName="adDate" />
//                 </div>

//                 {/* Vch. No. */}
//                 <div className="srv-header-cell" style={{ width: `${columnWidths.voucherNo}px`, flexShrink: 0, minWidth: '60px' }}>
//                     <strong>Vch. No.</strong>
//                     <ResizeHandle onResizeStart={handleResizeStart} left={columnWidths.voucherNo - 3} columnName="voucherNo" />
//                 </div>

//                 {/* Buyer's Name */}
//                 <div className="srv-header-cell" style={{ width: `${columnWidths.buyerName}px`, flexShrink: 0, minWidth: '100px' }}>
...
//                 {/* Buyer's PAN */}
//                 <div className="srv-header-cell" style={{ width: `${columnWidths.panNumber}px`, flexShrink: 0, minWidth: '80px' }}>
//                     <strong>Buyer's PAN</strong>
//                     <ResizeHandle onResizeStart={handleResizeStart} left={columnWidths.panNumber - 3} columnName="panNumber" />
//                 </div>

//                 {/* Total Amount */}
//                 <div className="srv-header-cell srv-header-cell--end" style={{ width: `${columnWidths.totalAmount}px`, flexShrink: 0, minWidth: '80px' }}>
//                     <strong>Total Amount</strong>
//                     <ResizeHandle onResizeStart={handleResizeStart} left={columnWidths.totalAmount - 2} columnName="totalAmount" />
//                 </div>

//                 {/* Discount */}
//                 <div className="srv-header-cell srv-header-cell--end" style={{ width: `${columnWidths.discount}px`, flexShrink: 0, minWidth: '80px' }}>
//                     <strong>Discount</strong>
//                     <ResizeHandle onResizeStart={handleResizeStart} left={columnWidths.discount - 2} columnName="discount" />
//                 </div>

//                 {/* Non-VAT Return */}
//                 <div className="srv-header-cell srv-header-cell--end" style={{ width: `${columnWidths.nonVatReturn}px`, flexShrink: 0, minWidth: '80px' }}>
...
//                 {/* Taxable Amt. */}
//                 <div className="srv-header-cell srv-header-cell--end" style={{ width: `${columnWidths.taxableAmount}px`, flexShrink: 0, minWidth: '80px' }}>
...
//                 {/* VAT */}
//                 <div className="srv-header-cell srv-header-cell--end" style={{ width: `${columnWidths.vatAmount}px`, flexShrink: 0, minWidth: '80px' }}>
//                     <strong>VAT</strong>
...
//             >
//                 {/* BS Date */}
//                 <div className="srv-cell srv-cell--center" style={{ width: `${columnWidths.bsDate}px`, flexShrink: 0, height: '100%' }}>
//                     <span>{report.nepaliDate || ''}</span>
//                 </div>

//                 {/* AD Date */}
//                 <div className="srv-cell srv-cell--center" style={{ width: `${columnWidths.adDate}px`, flexShrink: 0, height: '100%' }}>
//                     <span>{report.date ? new Date(report.date).toLocaleDateString() : ''}</span>
//                 </div>

//                 {/* Vch. No. */}
//                 <div className="srv-cell" style={{ width: `${columnWidths.voucherNo}px`, flexShrink: 0, height: '100%', overflow: 'hidden' }}>
//                     <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{report.billNumber || ''}</span>
//                 </div>

//                 {/* Buyer's Name */}
//                 <div className="srv-cell" style={{ width: `${columnWidths.buyerName}px`, flexShrink: 0, height: '100%', overflow: 'hidden' }} title={report.accountName || 'Cash Return'}>
//                     <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{report.accountName || 'Cash Return'}</span>
//                 </div>

//                 {/* Buyer's PAN */}
//                 <div className="srv-cell" style={{ width: `${columnWidths.panNumber}px`, flexShrink: 0, height: '100%', overflow: 'hidden' }}>
//                     <span style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{report.panNumber || ''}</span>
//                 </div>

//                 {/* Total Amount */}
//                 <div className="srv-cell srv-cell--end" style={{ width: `${columnWidths.totalAmount}px`, flexShrink: 0, height: '100%' }}>
//                     <span>{formatCurrency(report.totalAmount)}</span>
//                 </div>

//                 {/* Discount */}
//                 <div className="srv-cell srv-cell--end" style={{ width: `${columnWidths.discount}px`, flexShrink: 0, height: '100%' }}>
//                     <span>{formatCurrency(report.discountAmount)}</span>
//                 </div>

//                 {/* Non-VAT Return */}
//                 <div className="srv-cell srv-cell--end" style={{ width: `${columnWidths.nonVatReturn}px`, flexShrink: 0, height: '100%' }}>
//                     <span>{formatCurrency(report.nonVatSalesReturn)}</span>
//                 </div>

//                 {/* Taxable Amt. */}
//                 <div className="srv-cell srv-cell--end" style={{ width: `${columnWidths.taxableAmount}px`, flexShrink: 0, height: '100%' }}>
//                     <span>{formatCurrency(report.taxableAmount)}</span>
//                 </div>

//                 {/* VAT */}
//                 <div className="srv-cell srv-cell--end" style={{ width: `${columnWidths.vatAmount}px`, flexShrink: 0, height: '100%' }}>
...
//     if (loading && data.salesReturnVatReport.length === 0) return <Loader />;

//     if (error && data.salesReturnVatReport.length === 0) {
//         return (
...
//                     <div className="srv-topbar__left">
//                         <div className="srv-topbar__icon"><FiFileText /></div>
//                         <div><h1>Sales Return VAT Report</h1></div>
//                     </div>
//                     <div className="srv-topbar__actions">
//                         <button className="srv-btn-icon" onClick={handleExportExcel} disabled={data.salesReturnVatReport.length === 0 || exporting}>
//                             <FiDownload /> {exporting ? '…' : 'Excel'}
//                         </button>
//                         <button className="srv-btn-icon" onClick={handlePrint} disabled={filteredReports.length === 0}>
//                             <FiPrinter /> Print
//                         </button>
//                         <button className="srv-btn-icon" onClick={resetColumnWidths} title="Reset columns">
//                             <FiRefreshCw /> Reset
//                         </button>
//                     </div>
//                 </div>
...
//                     <div className="srv-field srv-field--date">
...
//                             autoComplete="off"
//                         />
//                         {dateErrors.fromDate && <div className="srv-field-error">{dateErrors.fromDate}</div>}
//                     </div>
...
//                             autoComplete="off"
//                         />
//                         {dateErrors.toDate && <div className="srv-field-error">{dateErrors.toDate}</div>}
//                     </div>
...
//                     <button type="button" id="generateReport" ref={generateReportRef} className="srv-btn-gen" onClick={handleGenerateReport} disabled={loading}>
//                         {loading ? <span className="spinner-border spinner-border-sm" style={{ width: 12, height: 12 }} /> : <><FiSearch className="me-1" /> Generate</>}
//                     </button>

//                     <div className="srv-toolbar-divider" />

//                     <div className="srv-field srv-field--search">
//                         <label>Search</label>
...
//                                 autoComplete="off"
//                             />
//                             {searchQuery && <button className="srv-search-clear" onClick={() => setSearchQuery('')}>×</button>}
//                         </div>
//                     </div>
//                 </div>

//                 {error && (
//                     <div className="srv-alert">
//                         <FiX /> {error}
...
//                         </div>
//                     ) : loading ? (
//                         <div className="srv-state"><div className="spinner-border text-primary" /><p>Loading data...</p></div>
...
//                                 <div className="srv-footer-cell" style={{ width: `${columnWidths.bsDate + columnWidths.adDate + columnWidths.voucherNo + columnWidths.buyerName + columnWidths.panNumber}px`, flexShrink: 0 }}>
//                                     <strong>Grand Totals:</strong>
//                                 </div>
//                                 <div className="srv-footer-cell srv-footer-cell--end" style={{ width: `${columnWidths.totalAmount}px`, flexShrink: 0 }}>
//                                     <strong>{formatCurrency(totals.totalAmount)}</strong>
//                                 </div>
//                                 <div className="srv-footer-cell srv-footer-cell--end" style={{ width: `${columnWidths.discount}px`, flexShrink: 0 }}>
//                                     <strong>{formatCurrency(totals.discountAmount)}</strong>
//                                 </div>
//                                 <div className="srv-footer-cell srv-footer-cell--end" style={{ width: `${columnWidths.nonVatReturn}px`, flexShrink: 0 }}>
//                                     <strong>{formatCurrency(totals.nonVatReturn)}</strong>
//                                 </div>
//                                 <div className="srv-footer-cell srv-footer-cell--end" style={{ width: `${columnWidths.taxableAmount}px`, flexShrink: 0 }}>
//                                     <strong>{formatCurrency(totals.taxableAmount)}</strong>
//                                 </div>
//                                 <div className="srv-footer-cell srv-footer-cell--end" style={{ width: `${columnWidths.vatAmount}px`, flexShrink: 0 }}>
...
/**
 * Build IRD Annex-5 style rows for Sales Return (बिक्री फिर्ता).
 * Per the PDF:
 *  - Miti (BS)
 *  - बीजक नम्बर (voucher number)
 *  - खरिदकर्ताको नाम (buyer name)
 *  - खरिदकर्ताको स्थायी लेखा नम्बर (buyer PAN)
 *  - जम्मा फिर्ता (रु) — total return
 *  - स्थानीय कर छूटको फिर्ता मूल्य (रु) — local tax-exempt return
 *  - करयोग्य फिर्ता: मूल्य (रु) + कर (रु) — taxable return value + VAT
 */
const buildIrdRows = (reports = []) => {
    return reports.map((r) => {
        const totalReturn = Number(r.totalAmount || 0);
        const nonVatReturn = Number(r.nonVatSalesReturn || 0);
        ...
        return {
            ...
            buyerName: r.accountName || 'Cash Return',
            buyerPan: r.panNumber || '',
            totalReturn: totalReturn,
            localExemptReturn: nonVatReturn,
...
const SalesReturnVatReport = () => {
    ...
    const irdTotals = useMemo(() => {
        return irdRows.reduce((acc, r) => ({
            ...
            localExemptReturn: acc.localExemptReturn + (r.localExemptReturn || 0),
            taxableAmount: acc.taxableAmount + (r.taxableAmount || 0),
            vatAmount: acc.vatAmount + (r.vatAmount || 0)
        }), { totalReturn: 0, localExemptReturn: 0, taxableAmount: 0, vatAmount: 0 });
    }, [irdRows]);
    ...
    const handleExportExcel = async () => {
        ...
        try {
            ...
            excelData.push([viewMode === 'ird' ? 'Sales Return VAT Return (बिक्री फिर्ता खाता)' : 'Sales Return VAT Report']);
            excelData.push(['Company:', data.currentCompanyName || 'N/A']);
            excelData.push(['Address:', data.company?.address || '', data.company?.city ? ', ' + data.company?.city : '']);
            excelData.push(['PAN:', data.company?.pan || '']);
            excelData.push(['From Date (BS):', dateRange.fromDate]);
            ...
            if (viewMode === 'ird') {
                excelData.push([
                    'मिति', 'बीजक नम्बर', 'खरिदकर्ताको नाम', 'स्थायी लेखा नम्बर',
                    'जम्मा फिर्ता (रु)', 'स्थानीय कर छूटको फिर्ता मूल्य (रु)',
                    'करयोग्य फिर्ता मूल्य (रु)', 'कर (रु)'
                ]);
                irdRows.forEach(r => {
                    excelData.push([
                        r.date, r.invoiceNo, r.buyerName, r.buyerPan,
                        formatCurrencyForExport(r.totalReturn),
                        formatCurrencyForExport(r.localExemptReturn),
                ...
                excelData.push([
                    ...
                    formatCurrencyForExport(irdTotals.localExemptReturn),
                ...
                excelData.push([
                    ...
                    formatCurrencyForExport(totals.nonVatReturn),
            ...
            ws['!cols'] = viewMode === 'ird'
                ? [{ wch: 14 }, { wch: 16 }, { wch: 28 }, { wch: 16 },
                   { wch: 18 }, { wch: 26 }, { wch: 18 }, { wch: 14 }]
                : [{ wch: 6 }, { wch: 14 }, { wch: 14 }, { wch: 14 }, { wch: 25 },
                   { wch: 14 }, { wch: 15 }, { wch: 12 }, { wch: 15 }, { wch: 15 }, { wch: 12 }];

            const wb = XLSX.utils.book_new();
            XLSX.utils.book_append_sheet(wb, ws, viewMode === 'ird' ? 'Sales Return VAT Return' : 'Sales Return VAT Report');

            const fileName = viewMode === 'ird'
                ? `Sales_Return_VAT_Return_${dateRange.fromDate}_to_${dateRange.toDate}_${currentDate}.xlsx`
                : `Sales_Return_VAT_Report_${dateRange.fromDate}_to_${dateRange.toDate}_${currentDate}.xlsx`;
    ...
    const handlePrint = () => {
        ...
        printWindow.document.write(`
            <html>
                <head>
                    <title>${viewMode === 'ird' ? 'Sales Return VAT Return' : 'Sales Return VAT Report'}</title>
                    <meta charset="UTF-8">
                    <style>
    ...
    const generateTablePrintContent = () => {
        ...
        let printTotals = {
            totalAmount: 0, discountAmount: 0, nonVatReturn: 0, taxableAmount: 0, vatAmount: 0
        };
        ...
        html += `
                <tr class="grand-total-row">
                    ...
                    <td class="text-end total-label">${formatCurrency(printTotals.nonVatReturn)}</td>
    ...
    // -------- IRD print (बिक्री फिर्ता खाता) --------
    const generateIrdPrintContent = () => {
        const t = irdTotals;

        let html = `
            <div class="print-header" style="text-align:center;">
                <div style="font-size:16px;font-weight:700;">बिक्री फिर्ता खाता</div>
            ...
            <table cellspacing="0" style="font-size:9px;">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="nowrap text-end">जम्मा फिर्ता (रु)</th>
                        <th rowspan="2" class="nowrap text-end">स्थानीय कर छूटको फिर्ता मूल्य (रु)</th>
                        <th colspan="2" class="nowrap text-center">करयोग्य फिर्ता</th>
                    </tr>
                    <tr>
        ...
        irdRows.forEach((r) => {
            html += `
                <tr>
                    ...
                    <td class="text-end">${formatCurrency(r.localExemptReturn)}</td>
        ...
        html += `
                <tr class="grand-total-row">
                    ...
                    <td class="text-end total-label">${formatCurrency(t.localExemptReturn)}</td>
    ...
    const resetColumnWidths = () => {
        setColumnWidths({
            bsDate: 80, adDate: 80, voucherNo: 100, buyerName: 200, panNumber: 100,
            totalAmount: 100, discount: 100, nonVatReturn: 120, taxableAmount: 100, vatAmount: 100
        });
    ...
    // ============================================================
    // IRD-style view (in-app)
    // ============================================================
    const IrdReturnView = () => {
        return (
            <div className="srv-ird-wrap">
                <div className="srv-ird-header">
                    <div className="srv-ird-title">बिक्री फिर्ता खाता</div>
                    <div className="srv-ird-subtitle">(नियम २३ को उपनियम (१) को खण्ड (ज) संग सम्बन्धित)</div>
                    <div className="srv-ird-meta">
                        <div><strong>करदाता दर्ता नं:</strong> {data.company?.pan || '-'}</div>
                        <div><strong>करदाताको नाम:</strong> {data.currentCompanyName || '-'}</div>
                        <div><strong>कर अवधि:</strong> {dateRange.fromDate} देखि {dateRange.toDate} सम्म</div>
                    </div>
                ...
                <div className="srv-ird-table-scroll">
                    <table className="srv-ird-table">
                        <thead>
                            <tr>
                                ...
                                <th rowSpan="2" className="text-end">जम्मा फिर्ता (रु)</th>
                                <th rowSpan="2" className="text-end">स्थानीय कर छूटको फिर्ता मूल्य (रु)</th>
                                <th colSpan="2" className="text-center">करयोग्य फिर्ता</th>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            {irdRows.length === 0 ? (
                                <tr>
                                    <td colSpan="8" className="text-center" style={{ padding: '20px', color: '#888' }}>
                                        No data
                                    </td>
                                </tr>
                            ) : (
                                irdRows.map((r, idx) => (
                                    <tr key={idx} className={idx % 2 === 0 ? 'odd' : ''}>
                                        <td>{r.date}</td>
                                        <td>{r.invoiceNo}</td>
                                        <td className="srv-ird-name" title={r.buyerName || 'Cash Return'}>
                                            {r.buyerName || 'Cash Return'}
                                        </td>
                                        <td>{r.buyerPan}</td>
                                        <td className="text-end">{formatCurrency(r.totalReturn)}</td>
                                        <td className="text-end">{formatCurrency(r.localExemptReturn)}</td>
                        ...
                        {irdRows.length > 0 && (
                            <tfoot>
                                <tr className="srv-ird-total-row">
                                    ...
                                    <td className="text-end"><strong>{formatCurrency(irdTotals.localExemptReturn)}</strong></td>
        ...
        <div className="srv-page">
            ...
            <div className="srv-shell">
                ...
                <div className="srv-topbar">
                    ...
                    <div className="srv-topbar__actions">
                        {/* View toggle */}
                        <div className="srv-view-toggle" role="group" aria-label="View mode">
                            <button
                                type="button"
                                className={`srv-view-btn ${viewMode === 'table' ? 'active' : ''}`}
                            ...
                            <button
                                type="button"
                                className={`srv-view-btn ${viewMode === 'ird' ? 'active' : ''}`}
