...
const SplitCompany = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            // Fetch companies from your existing endpoint
            ...
            // Fetch fiscal years from your existing endpoint
            try {
                const fiscalYearsResponse = await api.get('/api/FiscalYears/switch-fiscal-year');
                let fiscalYearsData = [];
                if (fiscalYearsResponse.data && fiscalYearsResponse.data.success) {
                    fiscalYearsData = fiscalYearsResponse.data.data?.fiscalYears || [];
                } else if (fiscalYearsResponse.data && fiscalYearsResponse.data.fiscalYears) {
                    fiscalYearsData = fiscalYearsResponse.data.fiscalYears;
                } else if (fiscalYearsResponse.data && fiscalYearsResponse.data.$values) {
                    fiscalYearsData = fiscalYearsResponse.data.$values;
                }
                setFiscalYears(fiscalYearsData);
            } catch (fyErr) {
