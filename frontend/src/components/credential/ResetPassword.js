...
//   // At the very top of your ResetPassword component
// useEffect(() => {
...
//     try {
//       const response = await api.post(`/api/user/reset-password/${token}`, {
...
const ResetPassword = () => {
  ...
  //   try {
  //     // Don't send token in headers, it's in the URL
  //     const response = await api.post(`/api/user/reset-password/${encodeURIComponent(token)}`, {
  //       password: formData.password,
  //       password2: formData.password2
  //     });
