...
const Header = ({ onMenuClick }) => {
  ...
  return (
    <Navbar bg="white" expand="lg" fixed="top" className="header px-3">
      <Container fluid className="px-0">
        ...
        <Nav className="ms-auto align-items-center gap-2">
          <Dropdown align="end">
            <Dropdown.Toggle variant="light" className="notification-btn p-0">
              <Bell size={20} />
              {notifications > 0 && (
                <Badge bg="danger" pill className="notification-badge">
                  {notifications}
          ...
          <Dropdown align="end">
            <Dropdown.Toggle variant="light" className="message-btn p-0">
              <Envelope size={20} />
              {messages > 0 && (
                <Badge bg="success" pill className="notification-badge">
                  {messages}
          ...
          <Dropdown align="end">
            <Dropdown.Toggle variant="light" className="profile-btn p-0">
              <PersonCircle size={32} />
              <span className="profile-name ms-2 d-none d-md-inline">
                John Admin
              </span>
