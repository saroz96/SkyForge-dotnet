...
//                                     Back up your company data to Google Drive automatically. All your companies will be backed up to your Google Drive.
//                                 </div>
//                             </div>
...
//                                                 View Backup History
//                                                 {lastBackupCount > 0 && (
//                                                     <span className="badge bg-light text-dark ms-2">{lastBackupCount}</span>
//                                                 )}
//                                             </button>
//                                         </div>
//                                     </div>
...
//                                                 • <strong>SQL</strong> - Complete database restore (requires pg_dump)<br />
...
//                                             <strong>Backup Location:</strong> Your backups are stored in
//                                             <a href="https://drive.google.com" target="_blank" rel="noopener noreferrer"> Google Drive → Ams_Backups</a>
//                                             <br />
//                                             <small className="text-muted">
//                                                 Each company has its own folder. Backups are automatically rotated (keeping last 10 backups per company).
//                                             </small>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                             <div className="alert alert-light border h-100">
//                                                 <small>
//                                                     <strong>📁 Format Information:</strong><br />
//                                                     • <strong>Compressed</strong> - Smallest file size, best for storage<br />
...
//                                                 <i className="bi bi-folder me-2"></i>
//                                                 <strong className="me-2">Backup Location:</strong>
//                                                 <a href="https://drive.google.com" target="_blank" rel="noopener noreferrer"> Google Drive → Ams_Backups</a>
//                                                 <br />
