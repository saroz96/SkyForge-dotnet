        ...
        <div className="container-fluid">
            ...
            <div className="card mt-2 shadow-lg p-0 expanded-card ledger-card compact">
                ...
                <div className="card-body p-2 p-md-3">
                    {/* Company Name Info */}
                    {currentCompanyName && (
                        <div className="alert alert-info text-center py-1 mb-2 small" style={{ fontSize: '0.75rem' }}>
                            <FaBuilding className="me-1" />
                            Managing fiscal years for: <strong>{currentCompanyName}</strong>
                            {companyDateFormat && (
                                <span className="ms-2">
                                    (Date Format: <strong className="text-uppercase">{companyDateFormat}</strong>)
                                </span>
                            )}
                        </div>
                    )}
                    ...
                    <div className="row mt-3">
                        <div className="col-12 text-center">
                            <button
                                ...
                                disabled={loading || switchingFiscalYearId}
                                style={{ fontSize: '0.7rem', padding: '4px 12px' }}
                            >
                                <FaSyncAlt className="me-1" style={{ fontSize: '10px' }} />
                                Refresh List
                            </button>
                        </div>
                    </div>
                    ...
                    {/* Info Note */}
                    <div className="alert alert-info mt-3 py-1 mb-0 small" style={{ fontSize: '0.7rem' }}>
                        <i className="fas fa-info-circle me-1"></i>
                        <strong>Note:</strong> Switching fiscal year will update your session. The page will refresh the list automatically.
                        {companyDateFormat === 'nepali' && (
                            <span className="ms-2">Dates are displayed in Nepali format (BS).</span>
                        )}
                        {companyDateFormat === 'english' && (
                            <span className="ms-2">Dates are displayed in English format (AD).</span>
                        )}
                    </div>
                </div>
            </div>
