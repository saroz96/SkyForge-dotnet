...
//                 // Get transfer dates: AD date as DateTime, BS date as string
...
//             // Get or create Stock in Hand account with target fiscal year
//             var stockInHandAccount = await GetOrCreateStockInHandAccountAsync(companyId, targetFiscalYearId);
...
//         /// Get or create Stock in Hand account under Current Assets group
//         /// </summary>
//         private async Task<Account?> GetOrCreateStockInHandAccountAsync(Guid companyId, Guid? fiscalYearId = null)
//         {
//             // First, try to find existing Stock in Hand account
//             var stockInHandAccount = await _context.Accounts
//                 .FirstOrDefaultAsync(a => a.CompanyId == companyId &&
...
//             // Get the active fiscal year for the company (or use provided fiscalYearId)
//             Guid activeFiscalYearId;
//             if (fiscalYearId.HasValue && fiscalYearId.Value != Guid.Empty)
//             {
//                 activeFiscalYearId = fiscalYearId.Value;
//             }
//             else
//             {
...
//                 AccountGroupsId = currentAssetsGroup.Id,
//                 CompanyId = companyId,
//                 // FiscalYearId = activeFiscalYearId,  // REQUIRED: Set the fiscal year
//                 OriginalFiscalYearId = activeFiscalYearId,  // Set original fiscal year as same
//                 OpeningBalanceType = "Dr",
//                 IsActive = true,
//                 IsDefaultAccount = true,
//                 Date = DateTime.UtcNow,
...
//         //         var suspenseAccount = await GetOrCreateSuspenseAccountAsync(companyId,fiscalYearId);
...
//                     AccountId = balance.AccountId,
//                     FiscalYearId = fiscalYearId,
//                     CompanyId = companyId,  // ADD THIS - CompanyId is required!
//                     Amount = balance.DebitAmount > 0 ? balance.DebitAmount : balance.CreditAmount,
//                     Type = balance.DebitAmount > 0 ? "Dr" : "Cr",
//                     Date = transferDateAd,
//                     NepaliDate = transferDateNepali,
...
//         private async Task<Account> GetOrCreateSuspenseAccountAsync(Guid companyId, Guid? fiscalYearId = null)
//         {
//             var suspenseAccount = await _context.Accounts
//                 .FirstOrDefaultAsync(a => a.CompanyId == companyId && a.Name == "Suspense Account");
