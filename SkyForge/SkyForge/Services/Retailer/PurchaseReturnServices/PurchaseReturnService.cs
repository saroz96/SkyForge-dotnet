...
namespace SkyForge.Services.Retailer.PurchaseReturnServices
{
    public class PurchaseReturnService : IPurchaseReturnService
    {
        ...
        //         // Calculate amounts (though they should be provided in DTO, we recalc for verification)
        //         decimal totalTaxableAmount = 0;
        //         decimal totalNonTaxableAmount = 0;
        ...
        //         decimal discount = dto.DiscountPercentage ?? 0;
        ...
        //         if (!isVatExempt || isVatAll)
        //         {
        //             calculatedVatAmount = (finalTaxableAmount * dto.VatPercentage) / 100;
        //         }

        //         decimal finalVatAmount = dto.VatAmount ?? calculatedVatAmount;
        //         decimal finalTotalAmount = finalTaxableAmount + finalNonTaxableAmount + finalVatAmount;

        //         decimal roundOffAmount = dto.RoundOffAmount ?? 0;
        ...
        //         var billItems = new List<PurchaseReturnItem>();
        ...
        //         if (finalVatAmount > 0 && vatAccount != null && !isVatExempt)
        //         {
        //             var vatTransaction = new Transaction
        //             {
        //                 Id = Guid.NewGuid(),
        ...
        //         if (roundOffAmount != 0 && roundOffAccount != null)
        //         {
        //             var roundOffTransaction = new Transaction
        //             {
        //                 Id = Guid.NewGuid(),
        ...
        //     {
        //         _logger.LogError(ex, "CONCURRENCY EXCEPTION in UpdatePurchaseReturnAsync for bill {BillId}", id);
