...
namespace SkyForge.Services.Retailer.StockStatusServices
{
    public class StockStatusService : IStockStatusService
    {
        ...
        //                        (isNepaliFormat ? p.Date < fromDate : p.Date < fromDate))
        //             .ToListAsync();
        ...
        //                        (isNepaliFormat ? s.Date < fromDate : s.Date < fromDate))
        //             .ToListAsync();
        ...
        //                         (isNepaliFormat ? sa.Date < fromDate : sa.Date < fromDate))
        //             .ToListAsync();
        ...
        //                         (isNepaliFormat ? pr.Date < fromDate : pr.Date < fromDate))
        //             .ToListAsync();
        ...
        //                         (isNepaliFormat ? sr.Date < fromDate : sr.Date < fromDate))
        //             .ToListAsync();
        ...
        //                        p.FiscalYearId == fiscalYearId &&
        //                        p.Items.Any(i => itemIds.Contains(i.ItemId)) &&
        //                        (isNepaliFormat ? (p.Date >= fromDate && p.Date <= toDate) : (p.Date >= fromDate && p.Date <= toDate)))
        //             .ToListAsync();
        ...
        //                        s.FiscalYearId == fiscalYearId &&
        //                        s.Items.Any(i => itemIds.Contains(i.ItemId)) &&
        //                        (isNepaliFormat ? (s.Date >= fromDate && s.Date <= toDate) : (s.Date >= fromDate && s.Date <= toDate)))
        //             .ToListAsync();
        ...
        //                         sa.FiscalYearId == fiscalYearId &&
        //                         sa.Items.Any(i => itemIds.Contains(i.ItemId)) &&
        //                         (isNepaliFormat ? (sa.Date >= fromDate && sa.Date <= toDate) : (sa.Date >= fromDate && sa.Date <= toDate)))
        //             .ToListAsync();
        ...
        //                         pr.FiscalYearId == fiscalYearId &&
        //                         pr.Items.Any(i => itemIds.Contains(i.ItemId)) &&
        //                         (isNepaliFormat ? (pr.Date >= fromDate && pr.Date <= toDate) : (pr.Date >= fromDate && pr.Date <= toDate)))
        //             .ToListAsync();
        ...
        //                         sr.FiscalYearId == fiscalYearId &&
        //                         sr.Items.Any(i => itemIds.Contains(i.ItemId)) &&
        //                         (isNepaliFormat ? (sr.Date >= fromDate && sr.Date <= toDate) : (sr.Date >= fromDate && sr.Date <= toDate)))
        //             .ToListAsync();
        ...
        //                          (isNepaliFormat ? se.Date <= toDate : se.Date <= toDate))
        //             .OrderBy(se => isNepaliFormat ? se.Date : se.Date)
        //             .ToListAsync();
