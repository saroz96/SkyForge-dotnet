...
namespace SkyForge.Controllers.Retailer
{
    ...
    public class SalesReturnController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetLastSalesReturnDate()
        {
            try
            {
                ...
                if (lastSalesReturn.nepaliDate != null)
                    nepaliDateString = lastSalesReturn.nepaliDate.ToString("yyyy-MM-dd");
                ...
                if (lastSalesReturn.transactionDateNepali != null)
                    transactionDateNepaliString = lastSalesReturn.transactionDateNepali.ToString("yyyy-MM-dd");
        ...
        // GET: api/retailer/salesReturn-vat-report
        ...
        public async Task<IActionResult> GetSalesReturnVatReport([FromQuery] string? fromDate = null, [FromQuery] string? toDate = null)
        {
            try
            {
                ...
                // Get sales return VAT report from service
                var reportData = await _salesReturnService.GetSalesReturnVatReportAsync(
                    companyIdGuid,
                    fiscalYearIdGuid,
                    fromDate,
                    toDate);
                ...
                _logger.LogInformation($"Successfully fetched sales return VAT report with {reportData.SalesReturnVatReport.Count} entries");
