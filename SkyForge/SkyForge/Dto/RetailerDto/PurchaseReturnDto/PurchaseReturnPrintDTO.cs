...
namespace SkyForge.Dto.RetailerDto.PurchaseReturnDto
{
    public class PurchaseReturnPrintDTO
    {
        ...
        public PurchaseReturnPrintBillDTO Bill { get; set; } = new();
    ...
    public class PurchaseReturnPrintBillDTO
    {
        ...
        public List<PurchaseReturnItemPrintDTO> Items { get; set; } = new();
    }
    ...
    public class PurchaseReturnItemPrintDTO
    {
        public Guid Id { get; set; }
