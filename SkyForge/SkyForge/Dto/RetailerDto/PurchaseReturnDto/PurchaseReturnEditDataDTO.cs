...
{
    public class PurchaseReturnEditDataDTO
    {
        public CompanyInfoDTO Company { get; set; }
        public PurchaseReturnResponseDTO PurchaseReturn { get; set; } = new();
    ...
    public class PurchaseReturnItemEditDTO : PurchaseReturnItemResponseDTO
    {
        public decimal Stock { get; set; }
        public decimal LatestPuPrice { get; set; }
