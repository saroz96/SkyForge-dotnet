...
namespace SkyForge.Dto.RetailerDto.DebitNoteDto
{
    ...
    public class CreateDebitNoteDto
    {
        ...
        public List<DebitNoteDebitEntryDto> DebitAccounts { get; set; }

        [Required]
        [MinLength(1, ErrorMessage = "At least one credit account is required")]
        public List<DebitNoteCreditEntryDto> CreditAccounts { get; set; }
    ...
    public class DebitNoteDebitEntryDto
    {
        [Required]
    ...
    public class DebitNoteCreditEntryDto
    {
        [Required]
        public Guid AccountId { get; set; }
    ...
    public class DebitNoteResponseDto
    {
        ...
        public List<DebitNoteDebitEntryResponseDto> DebitAccounts { get; set; }
        public List<DebitNoteCreditEntryResponseDto> CreditAccounts { get; set; }
        public string Description { get; set; }
        public Guid UserId { get; set; }
    ...
    public class DebitNoteDebitEntryResponseDto
    {
        public Guid Id { get; set; }
        public Guid AccountId { get; set; }
    ...
    public class DebitNoteCreditEntryResponseDto
    {
        public Guid Id { get; set; }
        public Guid AccountId { get; set; }
        public string AccountCode { get; set; }
    ...
    // For listing
    public class DebitNoteSummaryDto
    {
        public Guid Id { get; set; }
        public string BillNumber { get; set; }
        public DateTime Date { get; set; }
