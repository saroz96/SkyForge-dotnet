        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: false),
                    Date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    DutyScheduleId = table.Column<Guid>(type: "uuid", nullable: true),
                    ScheduledDutyHours = table.Column<ScheduledDutyHours>(type: "jsonb", nullable: true),
                    ClockIn = table.Column<ClockInData>(type: "jsonb", nullable: true),
                    ClockOut = table.Column<ClockOutData>(type: "jsonb", nullable: true),
                    ...
                    DeviceInfo = table.Column<DeviceInfo>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleDriveFileId = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "cash_counter_credit_notes",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    entry_type = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    account_name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_credit_notes", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_debit_notes",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_debit_notes", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_denominations",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                    denomination_type = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_denominations", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_journal_vouchers",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_journal_vouchers", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_payments",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_payments", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_purchase_bills",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_purchase_bills", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_purchase_returns",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_purchase_returns", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_receipts",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    receipt_mode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_receipts", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_sales_bills",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_sales_bills", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_sales_returns",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_sales_returns", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_sessions",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    expected_closing_balance = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    total_sales = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    total_returns = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    total_payments = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    total_receipts = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    cash_difference = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    opening_nepali_date = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    closing_nepali_date = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    opening_denominations_set = table.Column<bool>(type: "boolean", nullable: false),
                    closing_denominations_set = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_sessions", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "cash_counter_transactions",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    session_id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    created_at = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    nepali_date = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    user_id = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_cash_counter_transactions", x => x.id);
                    table.ForeignKey(
                        name: "FK_cash_counter_transactions_cash_counter_sessions_session_id",
                        column: x => x.session_id,
                        principalTable: "cash_counter_sessions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DutyHours = table.Column<DutyHours>(type: "jsonb", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DutySchedules_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DutySchedules_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UseVoucherLastDateForSales = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForSalesReturn = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForPurchase = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForPurchaseReturn = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForPayment = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForReceipt = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForJournal = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForDebitNote = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForCreditNote = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForSalesQuotation = table.Column<bool>(type: "boolean", nullable: false),
                    UseVoucherLastDateForStockAdjustment = table.Column<bool>(type: "boolean", nullable: false),
                    StoreManagement = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_item_closing_stock_by_fiscal_year_Companies_company_id",
                        column: x => x.company_id,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_item_initial_opening_stocks_Companies_company_id",
                        column: x => x.company_id,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentEntries_AccountGroups_AccountGroupId",
                        column: x => x.AccountGroupId,
                        principalTable: "AccountGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentEntries_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentEntries_Payments_PaymentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NepaliDate = table.Column<string>(type: "text", nullable: true),
                    TransactionDateNepali = table.Column<string>(type: "text", nullable: true),
                    date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    vat_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    total_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    total_cc_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    is_vat_exempt = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    is_vat_all = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    round_off_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    payment_mode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    alt_mrp = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseBillItem_VatStatus", "vat_status IN ('13', 'vatExempt')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    bill_quantity = table.Column<decimal>(type: "numeric(10,3)", precision: 10, scale: 3, nullable: false),
                    actual_quantity = table.Column<decimal>(type: "numeric(10,3)", precision: 10, scale: 3, nullable: false),
                    price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    pu_price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    mrp = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
                    margin_percentage = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 0m),
                    cc_percentage = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    item_cc_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    main_unit_pu_price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    currency = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    alt_quantity = table.Column<decimal>(type: "numeric(10,3)", precision: 10, scale: 3, nullable: true),
                    alt_price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    alt_pu_price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseReturnItem_VatStatus", "vat_status IN ('13', 'vatExempt')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SalesReturnItem_VatStatus", "vat_status IN ('13', 'vatExempt')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    main_unit_pu_price = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
                    mrp = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
                    margin_percentage = table.Column<decimal>(type: "numeric(10,4)", precision: 10, scale: 4, nullable: false, defaultValue: 0m),
                    currency = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    taxable_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    non_taxable_amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    PaymentReceiptType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    JournalAccountType = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    JournalAccountDrCrType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    DrCrNoteAccountType = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    DrCrNoteAccountTypes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    cash_settlement_status = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    cash_settlement_date = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    cash_settlement_user_id = table.Column<Guid>(type: "uuid", nullable: true),
                    cash_settlement_remarks = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.cash_settlement_user_id,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BackupHistories_CompanyId",
                table: "BackupHistories",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_BackupHistories_UserId",
                table: "BackupHistories",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CashCounterCreditNote_CreditNoteId",
                table: "cash_counter_credit_notes",
                column: "credit_note_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterCreditNote_Session_CreditNote",
                table: "cash_counter_credit_notes",
                columns: new[] { "session_id", "credit_note_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterCreditNote_SessionId",
                table: "cash_counter_credit_notes",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterDebitNote_DebitNoteId",
                table: "cash_counter_debit_notes",
                column: "debit_note_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterDebitNote_Session_DebitNote",
                table: "cash_counter_debit_notes",
                columns: new[] { "session_id", "debit_note_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterDebitNote_SessionId",
                table: "cash_counter_debit_notes",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_cash_counter_denominations_session_id",
                table: "cash_counter_denominations",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterJournalVoucher_JournalVoucherId",
                table: "cash_counter_journal_vouchers",
                column: "journal_voucher_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterJournalVoucher_Session_JournalVoucher",
                table: "cash_counter_journal_vouchers",
                columns: new[] { "session_id", "journal_voucher_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterJournalVoucher_SessionId",
                table: "cash_counter_journal_vouchers",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterPayment_PaymentId",
                table: "cash_counter_payments",
                column: "payment_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterPayment_Session_Payment",
                table: "cash_counter_payments",
                columns: new[] { "session_id", "payment_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterPayment_SessionId",
                table: "cash_counter_payments",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterPurchaseBill_PurchaseBillId",
                table: "cash_counter_purchase_bills",
                column: "purchase_bill_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterPurchaseBill_Session_PurchaseBill",
                table: "cash_counter_purchase_bills",
                columns: new[] { "session_id", "purchase_bill_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterPurchaseBill_SessionId",
                table: "cash_counter_purchase_bills",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterPurchaseReturn_PurchaseReturnId",
                table: "cash_counter_purchase_returns",
                column: "purchase_return_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterPurchaseReturn_Session_PurchaseReturn",
                table: "cash_counter_purchase_returns",
                columns: new[] { "session_id", "purchase_return_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterPurchaseReturn_SessionId",
                table: "cash_counter_purchase_returns",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterReceipt_ReceiptId",
                table: "cash_counter_receipts",
                column: "receipt_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterReceipt_Session_Receipt",
                table: "cash_counter_receipts",
                columns: new[] { "session_id", "receipt_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterReceipt_SessionId",
                table: "cash_counter_receipts",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterSalesBill_SalesBillId",
                table: "cash_counter_sales_bills",
                column: "sales_bill_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterSalesBill_Session_SalesBill",
                table: "cash_counter_sales_bills",
                columns: new[] { "session_id", "sales_bill_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterSalesBill_SessionId",
                table: "cash_counter_sales_bills",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterSalesReturn_SalesReturnId",
                table: "cash_counter_sales_returns",
                column: "sales_return_id");

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterSalesReturn_Session_SalesReturn",
                table: "cash_counter_sales_returns",
                columns: new[] { "session_id", "sales_return_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashCounterSalesReturn_SessionId",
                table: "cash_counter_sales_returns",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_cash_counter_sessions_company_id",
                table: "cash_counter_sessions",
                column: "company_id");

            migrationBuilder.CreateIndex(
                name: "IX_cash_counter_sessions_fiscal_year_id",
                table: "cash_counter_sessions",
                column: "fiscal_year_id");

            migrationBuilder.CreateIndex(
                name: "IX_cash_counter_sessions_user_id",
                table: "cash_counter_sessions",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "IX_cash_counter_transactions_session_id",
                table: "cash_counter_transactions",
                column: "session_id");

            migrationBuilder.CreateIndex(
                name: "IX_cash_counter_transactions_user_id",
                table: "cash_counter_transactions",
                column: "user_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Category_Company_UniqueNumber",
                table: "Categories",
                columns: new[] { "CompanyId", "UniqueNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Composition_Company_UniqueNumber",
                table: "compositions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_compositions_name_company_id",
                table: "compositions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditNotes_NepaliDate",
                table: "CreditNotes",
                column: "NepaliDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DutySchedules_CompanyId",
                table: "DutySchedules",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_DutySchedules_UserId",
                table: "DutySchedules",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_item_closing_stock_by_fiscal_year_company_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_item_initial_opening_stocks_company_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemCompany_Company_UniqueNumber",
                table: "ItemCompanies",
                columns: new[] { "CompanyId", "UniqueNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalEntries_Voucher_Type",
                table: "JournalEntries",
                columns: new[] { "JournalVoucherId", "EntryType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MainUnit_Company_UniqueNumber",
                table: "MainUnits",
                columns: new[] { "CompanyId", "UniqueNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_AccountGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_AccountId_EntryType",
                table: "PaymentEntries",
                columns: new[] { "AccountId", "EntryType" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_CreatedAt",
                table: "PaymentEntries",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_EntryType",
                table: "PaymentEntries",
                column: "EntryType");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_EntryType_Amount",
                table: "PaymentEntries",
                columns: new[] { "EntryType", "Amount" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_InstType",
                table: "PaymentEntries",
                column: "InstType");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_InstType_BankAcc",
                table: "PaymentEntries",
                columns: new[] { "InstType", "BankAcc" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_PaymentId",
                table: "PaymentEntries",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_PaymentId_AccountId_EntryType",
                table: "PaymentEntries",
                columns: new[] { "PaymentId", "AccountId", "EntryType" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_PaymentId_EntryType",
                table: "PaymentEntries",
                columns: new[] { "PaymentId", "EntryType" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentEntries_ReferenceNumber",
                table: "PaymentEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_CompanyId_FiscalYearId_BillNumber",
                table: "Payments",
                columns: new[] { "CompanyId", "FiscalYearId", "BillNumber" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Unit_Company_UniqueNumber",
                table: "Units",
                columns: new[] { "CompanyId", "UniqueNumber" },
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_credit_notes_cash_counter_sessions_session_id",
                table: "cash_counter_credit_notes",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_debit_notes_cash_counter_sessions_session_id",
                table: "cash_counter_debit_notes",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_denominations_cash_counter_sessions_session_id",
                table: "cash_counter_denominations",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_journal_vouchers_cash_counter_sessions_session~",
                table: "cash_counter_journal_vouchers",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_payments_cash_counter_sessions_session_id",
                table: "cash_counter_payments",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_purchase_bills_cash_counter_sessions_session_id",
                table: "cash_counter_purchase_bills",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_purchase_returns_cash_counter_sessions_session~",
                table: "cash_counter_purchase_returns",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_receipts_cash_counter_sessions_session_id",
                table: "cash_counter_receipts",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_sales_bills_cash_counter_sessions_session_id",
                table: "cash_counter_sales_bills",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_sales_returns_cash_counter_sessions_session_id",
                table: "cash_counter_sales_returns",
                column: "session_id",
                principalTable: "cash_counter_sessions",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_sessions_Companies_company_id",
                table: "cash_counter_sessions",
                column: "company_id",
                principalTable: "Companies",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_sessions_FiscalYears_fiscal_year_id",
                table: "cash_counter_sessions",
                column: "fiscal_year_id",
                principalTable: "FiscalYears",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_sessions_Users_user_id",
                table: "cash_counter_sessions",
                column: "user_id",
                principalTable: "Users",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_cash_counter_transactions_Users_user_id",
                table: "cash_counter_transactions",
                column: "user_id",
                principalTable: "Users",
                principalColumn: "Id",
