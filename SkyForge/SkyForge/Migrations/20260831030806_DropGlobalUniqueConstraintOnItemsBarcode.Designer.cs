...
namespace SkyForge.Migrations
{
    ...
    [Migration("20260831030806_DropGlobalUniqueConstraintOnItemsBarcode")]
    partial class DropGlobalUniqueConstraintOnItemsBarcode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkyForge.Models.AccountModel.AccountShareToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SkyForge.Models.Attendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<ClockInData>("ClockIn")
                        .HasColumnType("jsonb");

                    b.Property<ClockOutData>("ClockOut")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<ScheduledDutyHours>("ScheduledDutyHours")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("SkyForge.Models.DutySchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DutyHours>("DutyHours")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterCreditNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionId", "CreditNoteId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashCounterCreditNote_Session_CreditNote");

                    b.ToTable("cash_counter_credit_notes");
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterDebitNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionId", "DebitNoteId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashCounterDebitNote_Session_DebitNote");

                    b.ToTable("cash_counter_debit_notes");
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterDenomination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("cash_counter_denominations");
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterJournalVoucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionId", "JournalVoucherId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashCounterJournalVoucher_Session_JournalVoucher");

                    b.ToTable("cash_counter_journal_vouchers");
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionId", "PaymentId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashCounterPayment_Session_Payment");

                    b.ToTable("cash_counter_payments");
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterPurchaseBill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionId", "PurchaseBillId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashCounterPurchaseBill_Session_PurchaseBill");

                    b.ToTable("cash_counter_purchase_bills");
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterPurchaseReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionId", "PurchaseReturnId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashCounterPurchaseReturn_Session_PurchaseReturn");

                    b.ToTable("cash_counter_purchase_returns");
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionId", "ReceiptId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashCounterReceipt_Session_Receipt");

                    b.ToTable("cash_counter_receipts");
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterSalesBill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionId", "SalesBillId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashCounterSalesBill_Session_SalesBill");

                    b.ToTable("cash_counter_sales_bills", (string)null);
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterSalesReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SessionId", "SalesReturnId")
                        .IsUnique()
                        .HasDatabaseName("IX_CashCounterSalesReturn_Session_SalesReturn");

                    b.ToTable("cash_counter_sales_returns", (string)null);
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("ClosingDenominationsSet")
                        .HasColumnType("boolean")
                        .HasColumnName("closing_denominations_set");

                    b.Property<string>("ClosingNepaliDate")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("closing_nepali_date");
                    ...
                    b.Property<bool>("OpeningDenominationsSet")
                        .HasColumnType("boolean")
                        .HasColumnName("opening_denominations_set");

                    b.Property<string>("OpeningNepaliDate")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("opening_nepali_date");
                    ...
                    b.ToTable("cash_counter_sessions");
                });

            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("cash_counter_transactions");
                });
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.Purchase.PurchaseBillItem", b =>
                {
                    ...
                    b.Property<decimal?>("AltMrp")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("alt_mrp");
                    ...
                    b.ToTable("purchase_bill_items", null, t =>
                        {
                            t.HasCheckConstraint("CK_PurchaseBillItem_VatStatus", "vat_status IN ('13', 'vatExempt')");
                        });
                });
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.PurchaseReturnModel.PurchaseReturnItem", b =>
                {
                    ...
                    b.ToTable("purchase_return_items", null, t =>
                        {
                            t.HasCheckConstraint("CK_PurchaseReturnItem_VatStatus", "vat_status IN ('13', 'vatExempt')");
                        });
                });
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.ReceiptModel.ReceiptEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReceiptId", "EntryType");

                    b.HasIndex("ReceiptId", "AccountId", "EntryType");
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.SalesReturnModel.SalesReturnItem", b =>
                {
                    ...
                    b.ToTable("sales_return_items", null, t =>
                        {
                            t.HasCheckConstraint("CK_SalesReturnItem_VatStatus", "vat_status IN ('13', 'vatExempt')");
                        });
                });
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.TransactionModel.Transaction", b =>
                {
                    ...
                    b.Property<DateTime?>("CashSettlementDate")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("cash_settlement_date");

                    b.Property<string>("CashSettlementRemarks")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("cash_settlement_remarks");

                    b.Property<string>("CashSettlementStatus")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("cash_settlement_status");

                    b.Property<Guid?>("CashSettlementUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("cash_settlement_user_id");
                    ...
                    b.Property<string>("PaymentReceiptType")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("CashSettlementUserId");
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.TransactionModel.TransactionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TransactionId", "ItemId");
                                    ...
                                    b2.OwnsOne("SkyForge.Models.CompanyModel.Coordinates", "Coordinates", b3 =>
                                        {
                                            ...
                                            b3.Property<Guid>("OfficeLocationId")
                                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.CashCounterModel.CashCounterCreditNote", b =>
                {
                    b.HasOne("SkyForge.Models.Retailer.CashCounterModel.CashCounterSession", "Session")
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.TransactionModel.Transaction", b =>
                {
                    ...
                    b.HasOne("SkyForge.Models.UserModel.User", "CashSettlementUser")
                        .WithMany()
                        .HasForeignKey("CashSettlementUserId");
                    ...
                    b.Navigation("CashSettlementUser");
            ...
            modelBuilder.Entity("SkyForge.Models.Retailer.TransactionModel.TransactionItem", b =>
                {
                    ...
                    b.HasOne("SkyForge.Models.Retailer.TransactionModel.Transaction", "Transaction")
